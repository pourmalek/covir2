...
if regexm(c(os),"Mac") == 1 {
	...
	merge 1:1 date using "$pathcovir2/YYGU/Iran YYGU"
}
else if regexm(c(os),"Windows") == 1 merge 1:1 date using "$pathcovir2\YYGU\Iran YYGU"
...
(line DayDeaMeRaA08S00V99 date, sort lcolor(brown)) /// 7 "YYGU"
...
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 4 "IMPE" 5 "LANL" 6 "SRIV" 7 "YYGU") size(small) row(1)) ///
...
* * daily deaths, median or reference scenario wo SRIV
...
(line DayDeaMeRaA03S02V07 date, sort lcolor(magenta)) /// 4 "IMPE"
(line DayDeaMeRaA04S00V02 date, sort lcolor(gold)) /// 5 "LANL"
(line DayDeaMeRaA08S00V99 date, sort lcolor(brown)) /// 6 "YYGU"
if date >= td(01feb2020) & date <= td(23Aug2021) ///
, xtitle(Date) xlabel(21935 21965 21994 22025 22056 22087 22118 22149 22180 ///
22210 22240 22270 22300 22330 22360 22391 22422 22453 22484 22515, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 4 "IMPE" 5 "LANL" 6 "YYGU") size(small) row(1)) ///
subtitle("without SRIV", size(small)) ///
ttext(0 21jan2020  "Bah" 0 20feb2020  "Esf" 0 20mar2020  "Far" 0 20apr2020  "Ord" 0 21may2020  "Kho" ///
0 21jun2020  "Tir" 0 22jul2020  "Mor" 0 22aug2020  "Sha" 0 22sep2020  "Meh" ///
0 22oct2020  "Aba" 0 21nov2020  "Aza" 0 21dec2020  "Dey" 0 20jan2021  "Bah" ///
0 19feb2021  "Esf" 0 21mar2021  "Far" 0 21apr2021  "Ord" 0 22may2021  "Kho" ///
...
graph save "graph 11a2 COVID-19 daily deaths, Iran, reference scenarios wo SRIV.gph", replace
graph export "graph 11a2 COVID-19 daily deaths, Iran, reference scenarioswo SRIV.pdf", replace
...
(line DayDeaMeRaA08S00V99 date, sort lcolor(brown)) /// 9 "YYGU"
if date <= td(24Aug2021) ///
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "CF 2" 3 "CF 5" 4 "DELP" 5 "IHME" 6 "IMPE" 7 "LANL" 8 "SRIV" 9 "YYGU") size(small) row(1)) ///
...
* daily deaths, median or reference scenario, 20dec2020 on, wo SRIV
...
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 4 "IMPE" 5 "LANL") size(small) row(1)) ///
subtitle("after 2020-12-20, wo SRIV", size(small)) ///
ttext(0 21dec2020  "Dey" 0 20jan2021  "Bah" ///
0 19feb2021  "Esf" 0 21mar2021  "Far" 0 21apr2021  "Ord" 0 22may2021  "Kho" ///
0 22jun2021  "Tir" 0 23jul2021  "Mor"  0 23Aug2021  "Sha", size(small) color(black))

graph save "graph 12a2 COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on wo SRIV.gph", replace
graph export "graph 12a2 COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on wo SRIV.pdf", replace
...
(line DayCasMeRaA08S00V99 date, sort lcolor(brown)) /// 7 "YYGU"
if date >= td(01feb2020) & date <= td(23Aug2021) ///
...
(line DayCasMeRaA08S00V99 date, sort lcolor(brown)) /// 9 "YYGU"
...
(line TotDeaMeRaA08S00V99 date, sort lcolor(brown)) /// 7 "YYGU"
...
(line TotDeaMeRaA08S00V99 date, sort lcolor(brown)) /// 9 "YYGU"
if date >= td(31dec2019) & date <= td(23Aug2021) ///
, xtitle(Date) xlabel(#19, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
(line TotCasMeRaA08S00V99 date, sort lcolor(brown)) /// 7 "YYGU"
if date >= td(31dec2019) & date <= td(23Aug2021) ///
, xtitle(Date) xlabel(#19, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
(line TotCasMeRaA08S00V99 date, sort lcolor(brown)) /// 9 "YYGU"
if date >= td(31dec2019) & date <= td(23Aug2021) ///
, xtitle(Date) xlabel(#19, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases) title("COVID-19 total cases, Iran, reference scenarios", size(medium)) /// 
...
(line DayCfrMeRaA08S00V99 date, sort lcolor(brown)) /// 7 "YYGU"
if date >= td(31dec2019) & date <= td(23Aug2021) ///
, xtitle(Date) xlabel(#19, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
(line DayCfrMeRaA08S00V99 date, sort lcolor(brown)) /// 5 "YYGU"
if date >= td(01mar2020) & date <= td(23Aug2021) ///
, xtitle(Date) xlabel(#16, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "SRIV" 5 "YYGU") size(small) row(1)) ///
...
(line DayCfrMeRaA08S00V99 date, sort lcolor(brown)) /// 13 "YYGU"
(line DayCfrLoRaA08S00V99 date, sort lcolor(brown) lpattern(dash)) /// 14 "YYGU" lower
(line DayCfrUpRaA08S00V99 date, sort lcolor(brown) lpattern(dash)) /// 15 "YYGU" upper
if date >= td(01mar2020) & date <= td(23Aug2021) ///
, xtitle(Date) xlabel(#16, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "DELP" 4 "IHME" 7 "IMPE" 10 "SRIV" 13 "YYGU") size(small) row(1)) ///
...
(line DayActMeRaA07S09V00 date, sort lcolor(black)) /// 3 "GHAN" 
(line DayActMeRaA06S01V00 date, sort lcolor(red) lpattern(dash)) /// 4 "SOLT S1"
(line DayActMeRaA06S02V00 date, sort lcolor(blue) lpattern(dash)) /// 5 "SOLT S2"
(line DayActMeRaA08S00V99 date, sort lcolor(brown)) /// 6 "YYGU"
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "GHAN" 4 "SOLT S1" 5 "SOLT S2" 6 "YYGU") size(small) row(1)) ///
subtitle("  .", size(small) color(white))
...
* daily hospital-related outcomes, DELP, IHME, IMPE, wo extremes (IHME Bed need, IMPE Hosp demand)
...
* daily hospital-related outcomes, DELP, IHME, IMPE, wo extremes (IHME Bed need, IMPE Hosp demand), 2020-12-01 on 
...
* daily deaths estimated to reported (DER) all studies, 01mar2021 on, reference scenarios
...
(line DayDERMeRaA04S00V02 date, sort lcolor(gold)) /// 4 "LANL"
(line DayDERMeRaA05S00V02 date, sort lcolor(green)) /// 5 "SRIV"
if date >= td(28feb2021) & date <= td(23Aug2021) ///
...
graph save "graph 92 COVID-19 daily deaths estimated to reported, Iran, reference scenarios, 01mar2021 on.gph", replace
graph export "graph 92 COVID-19 daily deaths estimated to reported, Iran, reference scenarios, 01mar2021 on.pdf", replace
...
graph save "graph 92.1 COVID-19 daily deaths estimated to reported, Iran, reference scenarios, 19feb2021 1399-12-01 on.gph", replace
graph export "graph 92.1 COVID-19 daily deaths estimated to reported, Iran, reference scenarios, 19feb2021 1399-12-01 on.pdf", replace
...
* daily cases estimated to reported (CER) all studies, 2021-03-01 on, reference scenarios
...
graph save "graph 93 COVID-19 daily cases estimated to reported, Iran, reference scenarios, 2021-03-01 on.gph", replace
graph export "graph 93 COVID-19 daily cases estimated to reported, Iran, reference scenarios, 2021-03-01 on.pdf", replace
...
graph save "graph 93.1 COVID-19 daily cases estimated to reported, Iran, reference scenarios, 19feb2021 1399-12-01 on.gph", replace
graph export "graph 93.1 COVID-19 daily cases estimated to reported, Iran, reference scenarios, 19feb2021 1399-12-01 on.pdf", replace
...
* total deaths estimated to reported (DER) all studies, 2021-03-01 on, reference scenarios
...
(line TotDERMeRaA04S00V02 date, sort lcolor(gold)) /// 4 "LANL"
(line TotDERMeRaA05S00V02 date, sort lcolor(green)) /// 5 "SRIV"
if date >= td(01mar2021) & date <= td(23Aug2021) ///
, xtitle(Date) xlabel(#7, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths estimated to reported) title("COVID-19 total deaths estimated to reported, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
graph save "graph 96 COVID-19 total deaths estimated to reported, Iran, reference scenarios, 2021-03-01 on.gph", replace
graph export "graph 96 COVID-19 total deaths estimated to reported, Iran, reference scenarios, 2021-03-01 on.pdf", replace
...
* total cases estimated to reported (CER) all studies, 2021-03-01 on, reference scenarios
...
graph save "graph 98 COVID-19 total cases estimated to reported, Iran, reference scenarios, 2021-03-01 on.gph", replace
graph export "graph 98 COVID-19 total cases estimated to reported, Iran, reference scenarios, 2021-03-01 on.pdf", replace
...
* Max values of estimates by month 
...
tabstat ///
DayDeaMeRaA02S01V03 /// 2 IHME
DayDeaMeRaA03S02V07 /// 3 IMPE
DayDeaMeRaA04S00V02 /// 4 LANL
DayDeaMeRaA05S00V02 /// 5 SRIV
if date >= td(21mar2021) &  date <= td(20apr2021) , stat(max) 
...
DayDeaMeRaA04S00V02 /// 4 LANL
DayDeaMeRaA05S00V02 /// 5 SRIV
if date >= td(21apr2021) &  date <= td(21may2021) , stat(max) 
...
DayDeaMeRaA04S00V02 /// 4 LANL
DayDeaMeRaA05S00V02 /// 5 SRIV
if date >= td(22may2021) &  date <= td(21jun2021) , stat(max) 
...
tabstat ///
DayCasMeRaA02S01V03 /// 2 IHME
DayCasMeRaA03S02V07 /// 3 IMPE
DayCasMeRaA04S00V02 /// 4 LANL
DayCasMeRaA05S00V02 /// 5 SRIV
if date >= td(21mar2021) &  date <= td(20apr2021) , stat(max) 
...
* 1400-01 start of Khordad (all studies non-missing)

tabstat ///
TotDeaMeRaA02S01V03 /// 2 IHME
TotDeaMeRaA03S02V07 /// 3 IMPE
TotDeaMeRaA04S00V02 /// 4 LANL
TotDeaMeRaA05S00V02 /// 5 SRIV
if date == td(22May2021) , stat(max) 
...
* 1400-01 start of Khordad

tabstat ///
TotCasMeRaA02S01V03 /// 2 IHME
TotCasMeRaA03S02V07 /// 3 IMPE
TotCasMeRaA04S00V02 /// 4 LANL
TotCasMeRaA05S00V02 /// 5 SRIV
if date == td(22May2021) , stat(max) 
