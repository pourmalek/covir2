...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20210715/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20210715\code"
}
*
...
data in covir2-main/20210715/output/merge/country.dta
and graphs stored in:
covir2-main/covir2/20210715/output/merge/*.pdf
and covir2-main/20210715/output/IMPE/*.pdf
