...
DELP 20220527, IHME 20220506, No IMPE, SRIV 20220522
...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20220527 (old), with 20220527 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************
...
global DELPepoch 27May2022 // update release date
*            2/ ----------
...
global SRIVepoch 22May2022 // update release date																		 
*            9/ ----------
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220527/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220527\code"
}
*
...
do "$pathcovir2/IMPE/do country IMPE.do" // IMPE update 20220315 was released on 20220505 and is 60 days old on 20220527. Not included.
