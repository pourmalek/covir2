...
else if regexm(c(os),"Windows") == 1 merge 1:1 date using "$pathcovir2\Soltani\Iran SOLT"
...
local studylist JOHN DELP IHME IMPE LANL SRIV SOLT 
...
drop JOHN DELP IHME IMPE LANL SRIV SOLT
...
else if regexm(c(os),"Windows") == 1 local studylist JOHN DELP IHME IMPE LANL SRIV SOLT 
