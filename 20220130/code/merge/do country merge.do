...
graph export "graph 11 COVID-19 daily deaths, $country, JOHN, all time.pdf", replace
...
graph export "graph 12 COVID-19 daily deaths, $country, JOHN, 2021.pdf", replace
...
graph export "graph 12 COVID-19 daily deaths, $country, JOHN, 2022.pdf", replace
...
graph export "graph 21 COVID-19 daily cases, $country, JOHN, all time.pdf", replace
...
graph export "graph 22 COVID-19 daily cases, $country, JOHN, 2021.pdf", replace
...
graph export "graph 22 COVID-19 daily cases, $country, JOHN, 2022.pdf", replace
