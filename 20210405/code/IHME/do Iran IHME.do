...
if regexm(c(os),"Mac") == 1 {
	local path "/Users/`usrnam'/Downloads/covir2-main/20210405/code/IHME" 
	di "`path'"
}
else if regexm(c(os),"Windows") == 1 local path "C:\Users\\`usrnam'\Downloads\covir2-main\20210405\code\IHME"
di "`path'"
...
if regexm(c(os),"Mac") == 1 {
	...
	local path "C:\Users\\`usrnam'\Downloads\covir2-main\20210405\code\IHME"
	di "`path'"
}
*
...
capture shell mv -f "2021_04_01" ~/.Trash
