...
******************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 20210401 (old), with 20210401 (new) <<--           <<<--- * change update date here *
                                                                                                         ***************************
...
copy https://raw.githubusercontent.com/COVIDAnalytics/website/master/data/predicted/Global_V4_20210401.csv Global_V4_20210401.csv

import delimited using "Global_V4_20210401.csv", clear varnames(1)
