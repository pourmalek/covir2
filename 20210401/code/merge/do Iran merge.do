...
label var DayDERMeRaA01S00 "Daily Deaths estim to reported Mean DELP S0 V3"
...
label var DayCERMeRaA01S00 "Daily Cases estim to reported Mean DELP S0 V3"
...
label var TotDERMeRaA01S00 "Total Deaths estim to reported Mean DELP S0 V3"
...
label var TotCERMeRaA01S00 "Total Cases estim to reported Mean DELP S0 V3"
...
(line DayDeaMeRaA00S00_CF2 date, sort lcolor(cyan) lpattern(tight_dot)) /// 2 "JOHN" CF2
(line DayDeaMeRaA00S00_CF5 date, sort lcolor(cyan) lpattern(tight_dot)) /// 3 "JOHN" CF5
(line DayDeaMeRaA01S00 date, sort lcolor(red)) /// 4 "DELP" mean
...
(line DayDeaLoRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 11 IMPE lower
(line DayDeaUpRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 12 IMPE upper
(line DayDeaMeRaA04S00 date, sort lcolor(gold)) /// 13 LANL mean
(line DayDeaLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL lower
(line DayDeaUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 15 LANL upper
(line DayDeaMeRaA05S00 date, sort lcolor(green)) /// 16 "SRIV" mean
(line DayDeaMeRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 17 "SRIV" lower
(line DayDeaMeRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 18 "SRIV" upper
if date >= td(30nov2020) & date <= td(23Aug2021)  ///
, xtitle(Date) xlabel(#9, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) ///
...
(line DayCasMeRaA03S02 date, sort lcolor(magenta)) /// 10 IMPE mean
(line DayCasLoRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 11 IMPE lower
(line DayCasUpRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 12 IMPE upper
(line DayCasMeRaA04S00 date, sort lcolor(gold)) /// 13 LANL mean
(line DayCasLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL lower
(line DayCasUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 15 LANL upper
(line DayCasMeRaA05S00 date, sort lcolor(green)) /// 16 "SRIV" mean
(line DayCasLoRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 17 "SRIV" lower
(line DayCasUpRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 18 "SRIV" upper
if date <= td(23Aug2021) & date >= td(30nov2020) ///
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases) title("COVID-19 daily cases, Iran, reference scenarios", size(medium)) ///
...
twoway ///
(line DayCfrMeRaA01S00 date, sort lcolor(red)) /// 1 "DELP"
(line DayCfrMeRaA02S01 date, sort lcolor(black)) /// 2 "IHME"
(line DayCfrMeRaA03S02 date, sort lcolor(magenta)) /// 3 "IMPE"
...
twoway ///
(line DayHosMeRaA01S00 date, sort lcolor(red)  lwidth(thick)) /// 1 DELP Hospitalized (Daily Cases Active Hospitalized Mean DELP S0 V3)
(line DayVenMeRaA01S00 date, sort lcolor(red) lpattern(dash)  lwidth(thick)) /// 2 DELP Ventilated (Daily Cases Active Ventilated Mean DELP S0 V3)
