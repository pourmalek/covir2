...
DELP 20220529, IHME 20220610, No IMPE, SRIV 20220610
...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20220610 (old), with 20220610 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************
...
global SRIVepoch 10Jun2022 // update release date																		 
*            9/ ----------
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220610/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220610\code"
}
*
