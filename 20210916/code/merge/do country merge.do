...
(line TotDeaMeRaA04S00 date, sort lcolor(gold)) /// 6 "LANL"
(line TotDeaMeRaA05S00 date, sort lcolor(green)) /// 7 "SRIV"
if date >= td(01jan2020) ///
, xtitle(Date) xlabel(#$yticknalltime, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths) title("COVID-19 total deaths, $country", size(medium)) /// 
...
DayDeaMeSmA02S03 DayDeaUpSmA02S03 /// IHME daily deaths worse scenario mean upper
...
DayINFMeSmA02S01 DayINFUpSmA02S01 /// IHME daily infections reference scenario mean upper
DayINFMeSmA02S03 DayINFUpSmA02S03 /// IHME daily infections worse scenario mean upper
...
TotINFMeSmA02S01 TotINFUpSmA02S01 /// IHME total infections reference scenario mean upper
TotINFMeSmA02S03 TotINFUpSmA02S03 /// IHME total infections worse scenario mean upper
