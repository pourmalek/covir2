...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20220715 (old), with 20220715 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************
...
global SRIVepoch 15Jul2022 // update release date																		 
*            9/ ----------

global MEDRIVAdate 20220715 // https://charts.medriva.com/country/IR
*           10/ ----------
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220715/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220715\code"
}
*
