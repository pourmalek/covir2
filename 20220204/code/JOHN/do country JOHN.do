...
tssmooth ma DayDeaMeRaA00S00_CF3_window = DayDeaMeRaA00S00_CF3 if DayDeaMeRaA00S00_CF3 >= 0, window(3 1 3)

tssmooth ma DayDeaMeSmA00S00_CF3 = DayDeaMeRaA00S00_CF3_window, weights( 1 2 3 <4> 3 2 1) replace
...
tssmooth ma DayCasMeRaA00S00_CF5_window = DayCasMeRaA00S00_CF5 if DayCasMeRaA00S00_CF5 >= 0, window(3 1 3)

tssmooth ma DayCasMeSmA00S00_CF5 = DayCasMeRaA00S00_CF5_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayCasMeSmA00S00_CF5 "Daily cases smooth A00 JOHN correction factor 5"

drop DayCasMeSmA00S00_CF5
...
* gen DayCasMeSmA00S00_CF5

gen DayCasMeSmA00S00_CF5 = DayCasMeSmA00S00 * 5
...
gen DayCasMeSmA00S00wave6_CF5 = DayCasMeSmA00S00wave6 * 5
label var DayCasMeSmA00S00wave6_CF5 "DayCasMeSmA00S00 from 6th wave start correction factor 5"
...
gen DayDeaMeSmA00S00wave5_CF3 = DayDeaMeSmA00S00wave5 * 3
label var DayDeaMeSmA00S00wave5_CF3 "Daily deaths JOHN wave5 correction factor 3"
