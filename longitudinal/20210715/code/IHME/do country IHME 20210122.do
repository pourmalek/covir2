...
log using "log country IHME 20210122.smcl", replace

*****************************************************************************
* This is "do country IHME 20210122.do"
...
* 26	20210122	January	22	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-01-22/ihme-covid19.zip	
* 2021_01_22	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20210122 

* (2) web address directory: 				2021-01-22 

* (3) local dir name: 						2021_01_22
...
save "IHME 20210122 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_01_22 // local dir




view "log country IHME 20210122.smcl"
