...
log using "log country IHME 20210115.smcl", replace

*****************************************************************************
* This is "do country IHME 20210115.do"
...
* 25	20210115	January	15	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-01-15/ihme-covid19.zip	
* 2021-01-15	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20210115 

* (2) web address directory: 				2021-01-15 

* (3) local dir name: 						2021-01-15
...
save "IHME 20210115 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021-01-15 // local dir




view "log country IHME 20210115.smcl"
