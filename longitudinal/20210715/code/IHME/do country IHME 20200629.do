...
log using "log country IHME 20200629.smcl", replace

*****************************************************************************
* This is "do country IHME 20200629.do"
...
* 2	20200629	June	29	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-06-29/ihme-covid19.zip	
* 2020_06_27	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200629 

* (2) web address directory: 				2020-06-29 

* (3) local dir name: 						2020_06_27
...
save "IHME 20200629 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_06_27 // local dir




view "log country IHME 20200629.smcl"
