...
log using "log country IHME 20201210.smcl", replace

*****************************************************************************
* This is "do country IHME 20201210.do"
...
* 22	20201210	December	10	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-12-10/ihme-covid19.zip	
* 2020_12_10	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201210 

* (2) web address directory: 				2020-12-10 

* (3) local dir name: 						2020_12_10
...
save "IHME 20201210 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_12_10 // local dir




view "log country IHME 20201210.smcl"
