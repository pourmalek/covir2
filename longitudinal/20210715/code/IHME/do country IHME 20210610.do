...
log using "log country IHME 20210610.smcl", replace

*****************************************************************************
* This is "do country IHME 20210610.do"
...
* 45	20210610	June	10	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-06-10/ihme-covid19.zip	
...
* (1) update date: 							20210610 

* (2) web address directory: 				2021-06-10 
...
save "IHME 20210610 country.dta", replace
...
view "log country IHME 20210610.smcl"
