...
log using "log country IHME 20201119.smcl", replace

*****************************************************************************
* This is "do country IHME 20201119.do"
...
* 20	20201119	Novebmer	19	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-11-19/ihme-covid19.zip	
* 2020_11_19	reference_hospitalization_all_locs.csv			yes
...
* (1) update date: 							20201119 

* (2) web address directory: 				2020-11-19 

* (3) local dir name: 						2020_11_19
...
save "IHME 20201119 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_11_19 // local dir




view "log country IHME 20201119.smcl"
