...
log using "log country IHME 20201203.smcl", replace

*****************************************************************************
* This is "do country IHME 20201203.do"
...
* 21	20201203	December	3	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-12-03/ihme-covid19.zip	
* 2020_12_03	reference_hospitalization_all_locs.csv			yes
...
* (1) update date: 							20201203 

* (2) web address directory: 				2020-12-03 

* (3) local dir name: 						2020_12_03
...
save "IHME 20201203 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_12_03 // local dir




view "log country IHME 20201203.smcl"
