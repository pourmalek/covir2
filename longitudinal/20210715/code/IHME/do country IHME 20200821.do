...
log using "log country IHME 20200821.smcl", replace

*****************************************************************************
* This is "do country IHME 20200821.do"
...
* 8	20200821	August	21	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-08-21/ihme-covid19.zip	
* 2020_08_21	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200821 

* (2) web address directory: 				2020-08-21 

* (3) local dir name: 						2020_08_21
...
save "IHME 20200821 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_08_21 // local dir




view "log country IHME 20200821.smcl"
