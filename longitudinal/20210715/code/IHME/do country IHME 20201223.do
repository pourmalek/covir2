...
log using "log country IHME 20201223.smcl", replace

*****************************************************************************
* This is "do country IHME 20201223.do"
...
* 24	20201223	December	23	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-12-23/ihme-covid19.zip	
* 2020_12_23	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201223 

* (2) web address directory: 				2020-12-23 

* (3) local dir name: 						2020_12_23
...
save "IHME 20201223 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_12_23 // local dir




view "log country IHME 20201223.smcl"
