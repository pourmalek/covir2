...
log using "log country IHME 20210604.smcl", replace

*****************************************************************************
* This is "do country IHME 20210604.do"
...
* 44	20210604	June	4	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-06-04/ihme-covid19.zip	
...
* (1) update date: 							20210604 

* (2) web address directory: 				2021-06-04 
...
save "IHME 20210604 country.dta", replace
...
view "log country IHME 20210604.smcl"
