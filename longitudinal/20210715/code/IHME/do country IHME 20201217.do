...
log using "log country IHME 20201217.smcl", replace

*****************************************************************************
* This is "do country IHME 20201217.do"
...
* 23	20201217	December	17	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-12-17/ihme-covid19.zip	
* 2020_12_17	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201217 

* (2) web address directory: 				2020-12-17 

* (3) local dir name: 						2020_12_17
...
save "IHME 20201217 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_12_17 // local dir




view "log country IHME 20201217.smcl"
