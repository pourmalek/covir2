...
log using "log country IHME 20210528.smcl", replace

*****************************************************************************
* This is "do country IHME 20210528.do"
...
* 43	20210528	May	28	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-05-28/ihme-covid19.zip	
...
* (1) update date: 							20210528 

* (2) web address directory: 				2021-05-28 
...
save "IHME 20210528 country.dta", replace
...
view "log country IHME 20210528.smcl"
