...
log using "log country IHME 20210506.smcl", replace

*****************************************************************************
* This is "do country IHME 20210506.do"
...
* 40	20210506	May	6	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-05-06/ihme-covid19.zip	
* 2021-05-06	reference_hospitalization_all_locs.csv			yes
...
* (1) update date: 							20210506 

* (2) web address directory: 				2021-05-06 

* (3) local dir name: 						2021-05-06
...
save "IHME 20210506 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021-05-06 // local dir




view "log country IHME 20210506.smcl"
