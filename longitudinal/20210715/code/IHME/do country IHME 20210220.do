...
log using "log country IHME 20210220.smcl", replace

*****************************************************************************
* This is "do country IHME 20210220.do"
...
* 30	20210220	February	20	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-02-20/ihme-covid19.zip	
* 2021_02_20	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20210220 

* (2) web address directory: 				2021-02-20 

* (3) local dir name: 						2021_02_20
...
save "IHME 20210220 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_02_20 // local dir




view "log country IHME 20210220.smcl"
