...
log using "log country IHME 20210128.smcl", replace

*****************************************************************************
* This is "do country IHME 20210128.do"
...
* 27	20210128	January	28	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-01-28/ihme-covid19.zip	
* 2021_01_28	reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20210128 

* (2) web address directory: 				2021-01-28 

* (3) local dir name: 						2021_01_28
...
save "IHME 20210128 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_01_28 // local dir




view "log country IHME 20210128.smcl"
