...
log using "log country IHME 20200903.smcl", replace

*****************************************************************************
* This is "do country IHME 20200903.do"
...
* 10	20200903	September	3	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-09-03/ihme-covid19.zip	
* 2020_09_02	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200903 

* (2) web address directory: 				2020-09-03 

* (3) local dir name: 						2020_09_02
...
save "IHME 20200903 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_09_02 // local dir




view "log country IHME 20200903.smcl"
