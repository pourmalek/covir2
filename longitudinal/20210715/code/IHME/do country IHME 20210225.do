...
log using "log country IHME 20210225.smcl", replace

*****************************************************************************
* This is "do country IHME 20210225.do"
...
* 31	20210225	February	25	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-02-25/ihme-covid19.zip	
* 2021_02_25	reference_hospitalization_all_locs.csv			yes
...
* (1) update date: 							20210225 

* (2) web address directory: 				2021-02-25 

* (3) local dir name: 						2021_02_25
...
save "IHME 20210225 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_02_25 // local dir




view "log country IHME 20210225.smcl"
