...
log using "log country IHME 20210409.smcl", replace

*****************************************************************************
* This is "do country IHME 20210409.do"
...
* 37	20210409	April	9	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-04-09/ihme-covid19.zip	
* 2021_04_09	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20210409 

* (2) web address directory: 				2021-04-09 

* (3) local dir name: 						2021_04_09
...
save "IHME 20210409 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_04_09 // local dir




view "log country IHME 20210409.smcl"
