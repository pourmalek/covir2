...
log using "log country IHME 20200714.smcl", replace

*****************************************************************************
* This is "do country IHME 20200714.do"
...
* 4	20200714	July	14	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-07-14/ihme-covid19.zip	
* 2020_07_11	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200714 

* (2) web address directory: 				2020-07-14 

* (3) local dir name: 						2020_07_11
...
save "IHME 20200714 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_07_11 // local dir




view "log country IHME 20200714.smcl"
