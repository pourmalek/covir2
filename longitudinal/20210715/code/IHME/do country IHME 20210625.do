...
log using "log country IHME 20210625.smcl", replace

*****************************************************************************
* This is "do country IHME 20210625.do"
...
* 47	20210625	June	25	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-06-25/ihme-covid19.zip	
* ihme-covid19	reference_hospitalization_all_locs			no
...
* (1) update date: 							20210625 

* (2) web address directory: 				2021-06-25 

* (3) local dir name: 						not needed because cd not needed

* (4) reference scenario csv file name		reference_hospitalization_all_locs: file name with small or captital R                                        

* (5) cd local dir name or not cd?
...
save "IHME 20210625 country.dta", replace
...
view "log country IHME 20210625.smcl"
