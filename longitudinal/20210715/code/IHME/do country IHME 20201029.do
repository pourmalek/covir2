...
log using "log country IHME 20201029.smcl", replace

*****************************************************************************
* This is "do country IHME 20201029.do"
...
* 18	20201029	October	29	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-10-29/ihme-covid19.zip	
* 2020_10_29	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201029 

* (2) web address directory: 				2020-10-29 

* (3) local dir name: 						2020_10_29
...
save "IHME 20201029 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_10_29 // local dir




view "log country IHME 20201029.smcl"
