...
log using "log country IHME 20210212.smcl", replace

*****************************************************************************
* This is "do country IHME 20210212.do"
...
* 29	20210212	February	12	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-02-12/ihme-covid19.zip	
* 2021_02_12	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20210212 

* (2) web address directory: 				2021-02-12 

* (3) local dir name: 						2021_02_12
...
save "IHME 20210212 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_02_12 // local dir




view "log country IHME 20210212.smcl"
