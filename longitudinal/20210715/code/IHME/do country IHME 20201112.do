...
log using "log country IHME 20201112.smcl", replace

*****************************************************************************
* This is "do country IHME 20201112.do"
...
* 19	20201112	Novebmer	12	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-11-12/ihme-covid19.zip	
* 2020_11_12	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201112 

* (2) web address directory: 				2020-11-12 

* (3) local dir name: 						2020_11_12
...
save "IHME 20201112 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_11_12 // local dir




view "log country IHME 20201112.smcl"
