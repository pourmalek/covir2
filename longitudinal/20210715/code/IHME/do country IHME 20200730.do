...
log using "log country IHME 20200730.smcl", replace

*****************************************************************************
* This is "do country IHME 20200730.do"
...
* 6	20200730	July	30	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-07-30/ihme-covid19.zip	
* 2020_07_26	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200730 

* (2) web address directory: 				2020-07-30 

* (3) local dir name: 						2020_07_26
...
save "IHME 20200730 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_07_26 // local dir




view "log country IHME 20200730.smcl"
