...
log using "log country IHME 20200722.smcl", replace

*****************************************************************************
* This is "do country IHME 20200722.do"
...
* 5	20200722	July	22	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-07-22/ihme-covid19.zip	
* 2020_07_18	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200722 

* (2) web address directory: 				2020-07-22 

* (3) local dir name: 						2020_07_18
...
save "IHME 20200722 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_07_18 // local dir




view "log country IHME 20200722.smcl"
