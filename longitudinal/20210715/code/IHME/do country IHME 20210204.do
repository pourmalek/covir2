...
log using "log country IHME 20210204.smcl", replace

*****************************************************************************
* This is "do country IHME 20210204.do"
...
* 28	20210204	February	4	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-02-04/ihme-covid19.zip	
* 2021_02_04	reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20210204 

* (2) web address directory: 				2021-02-04 

* (3) local dir name: 						2021_02_04
...
save "IHME 20210204 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_02_04 // local dir




view "log country IHME 20210204.smcl"
