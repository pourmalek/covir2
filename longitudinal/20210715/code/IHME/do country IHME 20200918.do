...
log using "log country IHME 20200918.smcl", replace

*****************************************************************************
* This is "do country IHME 20200918.do"
...
* 12	20200918	September	18	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-09-18/ihme-covid19.zip	
* 2020_09_18	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200918 

* (2) web address directory: 				2020-09-18 

* (3) local dir name: 						2020_09_18
...
save "IHME 20200918 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_09_18 // local dir




view "log country IHME 20200918.smcl"
