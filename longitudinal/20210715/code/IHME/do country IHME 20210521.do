...
log using "log country IHME 20210521.smcl", replace

*****************************************************************************
* This is "do country IHME 20210521.do"
...
* 42	20210521	May	21	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-05-21/ihme-covid19.zip	
...
* (1) update date: 							20210521 

* (2) web address directory: 				2021-05-21 
...
save "IHME 20210521 country.dta", replace
...
view "log country IHME 20210521.smcl"
