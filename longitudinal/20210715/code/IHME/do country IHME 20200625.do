...
log using "log country IHME 20200625.smcl", replace

*****************************************************************************
* This is "do country IHME 20200625.do"
...
* 1	20200625	June	25	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-06-25/ihme-covid19.zip	
* 2020_06_24.02	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200625 

* (2) web address directory: 				2020-06-25 

* (3) local dir name: 						2020_06_24.02

* (4) reference scenario csv file name		Reference_hospitalization_all_locs: file name with small or _captital R_                                        

* (5) cd local dir name or not cd?			yes cd

* (6) has inf_cuml_mean (TotINFMeRaA02S01) and est_infections_mean (DayINFMeRaA02S01) ? _NO_
...
save "IHME 20200625 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_06_24.02 // local dir




view "log country IHME 20200625.smcl"
