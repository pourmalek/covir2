...
log using "log country IHME 20201002.smcl", replace

*****************************************************************************
* This is "do country IHME 20201002.do"
...
* 14	20201002	October	2	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-10-02/ihme-covid19.zip	 
* 2020_10_02	Reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201002 

* (2) web address directory: 				2020-10-02 

* (3) local dir name: 						2020_10_02
...
save "IHME 20201002 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_10_02 // local dir




view "log country IHME 20201002.smcl"
