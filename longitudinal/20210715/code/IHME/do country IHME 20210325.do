...
log using "log country IHME 20210325.smcl", replace

*****************************************************************************
* This is "do country IHME 20210325.do"
...
* 35	20210325	March	25	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-03-25/ihme-covid19.zip	
* 2021_03_25	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20210325 

* (2) web address directory: 				2021-03-25 

* (3) local dir name: 						2021_03_25
...
save "IHME 20210325 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_03_25 // local dir




view "log country IHME 20210325.smcl"
