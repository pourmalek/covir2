...
log using "log country IHME 20210401.smcl", replace

*****************************************************************************
* This is "do country IHME 20210401.do"
...
* 36	20210401	April	1	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-04-01/ihme-covid19.zip	
* 2021_04_01	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20210401 

* (2) web address directory: 				2021-04-01 

* (3) local dir name: 						2021_04_01
...
save "IHME 20210401 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_04_01 // local dir




view "log country IHME 20210401.smcl"
