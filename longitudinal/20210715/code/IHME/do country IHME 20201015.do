...
log using "log country IHME 20201015.smcl", replace

*****************************************************************************
* This is "do country IHME 20201015.do"
...
* 16	20201015	October	15	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-10-15/ihme-covid19.zip	
* 2020_10_15	Reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201015 

* (2) web address directory: 				2020-10-15 

* (3) local dir name: 						2020_10_15
...
save "IHME 20201015 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_10_15 // local dir




view "log country IHME 20201015.smcl"
