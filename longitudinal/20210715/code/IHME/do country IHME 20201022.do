...
log using "log country IHME 20201022.smcl", replace

*****************************************************************************
* This is "do country IHME 20201022.do"
...
* 17	20201022	October	22	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-10-22/ihme-covid19.zip	
* 2020_10_22	Reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201022 

* (2) web address directory: 				2020-10-22 

* (3) local dir name: 						2020_10_22
...
save "IHME 20201022 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_10_22 // local dir




view "log country IHME 20201022.smcl"
