...
log using "log country IHME 20210715.smcl", replace

*****************************************************************************
* This is "do country IHME 20210715.do"
...
* 49	20210715	July	15	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-07-15/ihme-covid19.zip	
...
* (1) update date: 							20210715 

* (2) web address directory: 				2021-07-15 
...
save "IHME 20210715 country.dta", replace
...
view "log country IHME 20210715.smcl"
