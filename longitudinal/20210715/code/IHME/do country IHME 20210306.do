...
log using "log country IHME 20210306.smcl", replace

*****************************************************************************
* This is "do country IHME 20210306.do"
...
* 32	20210306	March	6	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-03-06/ihme-covid19.zip	
* 2021_03_06	reference_hospitalization_all_locs			yes	yes
...
* (1) update date: 							20210306 

* (2) web address directory: 				2021-03-06 

* (3) local dir name: 						2021_03_06
...
save "IHME 20210306 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_03_06 // local dir




view "log country IHME 20210306.smcl"
