...
log using "log country IHME 20210416.smcl", replace

*****************************************************************************
* This is "do country IHME 20210416.do"
...
* 38	20210416	April	16	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-04-16/ihme-covid19.zip	
* 2021-04-16	reference_hospitalization_all_locs.csv			yes
...
* (1) update date: 							20210416 

* (2) web address directory: 				2021-04-16 

* (3) local dir name: 						2021-04-16
...
save "IHME 20210416 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021-04-16 // local dir




view "log country IHME 20210416.smcl"
