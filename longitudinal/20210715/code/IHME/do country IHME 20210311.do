...
log using "log country IHME 20210311.smcl", replace

*****************************************************************************
* This is "do country IHME 20210311.do"
...
* 33	20210311	March	11	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-03-11/ihme-covid19.zip	
* 2021_03_11	reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20210311 

* (2) web address directory: 				2021-03-11 

* (3) local dir name: 						2021_03_11
...
save "IHME 20210311 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_03_11 // local dir




view "log country IHME 20210311.smcl"
