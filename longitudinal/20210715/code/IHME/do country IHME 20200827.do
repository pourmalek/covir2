...
log using "log country IHME 20200827.smcl", replace

*****************************************************************************
* This is "do country IHME 20200827.do"
...
* 9	20200827	August	27	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-08-27/ihme-covid19.zip	
* 2020_08_27	Reference_hospitalization_all_locs			yes
...
* (1) update date: 							20200827 

* (2) web address directory: 				2020-08-27 

* (3) local dir name: 						2020_08_27
...
save "IHME 20200827 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_08_27 // local dir




view "log country IHME 20200827.smcl"
