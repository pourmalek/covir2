...
log using "log country IHME 20200806.smcl", replace

*****************************************************************************
* This is "do country IHME 20200806.do"
...
* 7	20200806	August	6	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-08-06/ihme-covid19.zip	
* 2020_08_06	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200806 

* (2) web address directory: 				2020-08-06 

* (3) local dir name: 						2020_08_06
...
save "IHME 20200806 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_08_06 // local dir




view "log country IHME 20200806.smcl"
