...
log using "log country IHME 20201009.smcl", replace

*****************************************************************************
* This is "do country IHME 20201009.do"
...
* 15	20201009	October	9	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-10-09/ihme-covid19.zip	
* 2020_10_09	Reference_hospitalization_all_locs			yes
...
* (1) update date: 							20201009 

* (2) web address directory: 				2020-10-09 

* (3) local dir name: 						2020_10_09
...
save "IHME 20201009 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_10_09 // local dir




view "log country IHME 20201009.smcl"
