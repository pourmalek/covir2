...
log using "log country IHME 20200911.smcl", replace

*****************************************************************************
* This is "do country IHME 20200911.do"
...
* 11	20200911	September	11	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-09-11/ihme-covid19.zip	
* 2020_09_11	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200911 

* (2) web address directory: 				2020-09-11 

* (3) local dir name: 						2020_09_11
...
save "IHME 20200911 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_09_11 // local dir




view "log country IHME 20200911.smcl"
