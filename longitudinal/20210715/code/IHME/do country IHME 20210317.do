...
log using "log country IHME 20210317.smcl", replace

*****************************************************************************
* This is "do country IHME 20210317.do"
...
* 34	20210317	March	17	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-03-17/ihme-covid19.zip	
* 2021_03_17	reference_hospitalization_all_locs			yes
...
* (1) update date: 							20210317 

* (2) web address directory: 				2021-03-17 

* (3) local dir name: 						2021_03_17
...
save "IHME 20210317 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2021_03_17 // local dir




view "log country IHME 20210317.smcl"
