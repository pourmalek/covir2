...
log using "log country IHME 20200924.smcl", replace

*****************************************************************************
* This is "do country IHME 20200924.do"
...
* 13	20200924	September	24	2020	https://ihmecovid19storage.blob.core.windows.net/archive/2020-09-24/ihme-covid19.zip	
* 2020_09_24	Reference_hospitalization_all_locs			yes	
...
* (1) update date: 							20200924 

* (2) web address directory: 				2020-09-24 

* (3) local dir name: 						2020_09_24
...
save "IHME 20200924 country.dta", replace

shell rm -r reference_hospitalization_all_locs.csv

shell rm -r 2020_09_24 // local dir




view "log country IHME 20200924.smcl"
