...
log using "log country IHME 20210514.smcl", replace

*****************************************************************************
* This is "do country IHME 20210514.do"
...
* 41	20210514	May	14	2021	https://ihmecovid19storage.blob.core.windows.net/archive/2021-05-14/ihme-covid19.zip	
...
* (1) update date: 							20210514 

* (2) web address directory: 				2021-05-14 
...
save "IHME 20210514 country.dta", replace
...
view "log country IHME 20210514.smcl"
