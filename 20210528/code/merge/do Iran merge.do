...
if regexm(c(os),"Mac") == 1 {
	...
	merge 1:1 date using "$pathcovir2/UCLA/Iran UCLA"
}
else if regexm(c(os),"Windows") == 1 merge 1:1 date using "$pathcovir2\UCLA\Iran UCLA"
...
gen DayCTDMeRaA17S00  = DayCasMeRaA17S00  / DayDeaMeRaA17S00   

label var DayCTDMeRaA17S00  "Daily Cases to Deaths S0 UCLA"

gen TotCTDMeRaA17S00  = TotCasMeRaA17S00  / TotDeaMeRaA17S00   

label var TotCTDMeRaA17S00  "Total Cases to Deaths S0 UCLA"
...
gen DayDERMeRaA17S00  = DayDeaMeRaA17S00 / DayDeaMeRaA00S00

label var DayDERMeRaA17S00 "Daily Deaths estim to reported S0 UCLA"
...
gen DayCERMeRaA17S00  = DayCasMeRaA17S00 / DayCasMeRaA00S00

label var DayCERMeRaA17S00 "Daily Cases estim to reported S0 UCLA"
...
gen TotDERMeRaA17S00  = TotDeaMeRaA17S00 / TotDeaMeRaA00S00

label var TotDERMeRaA17S00 "Total Deaths estim to reported S0 UCLA"
...
gen TotCERMeRaA17S00  = TotCasMeRaA17S00 / TotCasMeRaA00S00

label var TotCERMeRaA17S00 "Total Cases estim to reported S0 UCLA"
...
(line DayDeaMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
...
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 4 "IMPE" 5 "LANL" 6 "SRIV" 7 "UCLA") size(small) row(1)) ///
...
* daily deaths, median or reference scenario, wo DELP for this uptake
...
(line DayDeaMeRaA17S00 date, sort lcolor(brown)) /// 6 "UCLA"
if date >= td(22nov2019) & date <= td(22Dec2021) ///
, xtitle(Date) xlabel(21875 21905 21935 21965 21994 22025 22056 22087 22118 22149 22180 ///
22210 22240 22270 22300 22330 22360 22391 22422 22453 22484 22515 22546 22576 22606 22636, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "UCLA") size(small) row(1)) ///
subtitle("without DELP for this uptake", size(small)) ///
ttext(0 22nov2019  "Aza" 0 22dec2019  "Dey" 0 21jan2020  "Bah" 0 20feb2020  "Esf" ///
0 20mar2020  "99"   0 20apr2020  "Ord" 0 21may2020  "Kho" ///
0 21jun2020  "Tir"  0 22jul2020  "Mor" 0 22aug2020  "Sha" ///
0 22sep2020  "Meh"  0 22oct2020  "Aba" 0 21nov2020  "Aza" ///
...
graph save "graph 11 b COVID-19 daily deaths, Iran, reference scenarios, wo DELP for this uptake.gph", replace
graph export "graph 11 b COVID-19 daily deaths, Iran, reference scenarios, wo DELP for this uptake.pdf", replace
...
(line DayDeaMeRaA00S00_CF2 date, sort lcolor(cyan) lpattern(tight_dot)) /// 2 "JOHN" CF2
(line DayDeaMeRaA00S00_CF5 date, sort lcolor(cyan) lpattern(tight_dot)) /// 3 "JOHN" CF5
(line DayDeaMeRaA01S00 date, sort lcolor(red)) /// 4 "DELP"
...
(line DayDeaMeRaA17S00 date, sort lcolor(brown)) /// 9 "UCLA"
if date >= td(22nov2019) & date <= td(22Dec2021) ///
, xtitle(Date) xlabel(21875 21905 21935 21965 21994 22025 22056 22087 22118 22149 22180 ///
22210 22240 22270 22300 22330 22360 22391 22422 22453 22484 22515 22546 22576 22606 22636, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "CF 2" 3 "CF 5" 4 "DELP" 5 "IHME" 6 "IMPE" 7 "LANL" 8 "SRIV" 9 "UCLA") size(small) row(1)) ///
...
graph save "graph 12 COVID-19 daily deaths, Iran, reference scenarios, w CF.gph", replace
graph export "graph 12 COVID-19 daily deaths, Iran, reference scenarios, w CF.pdf", replace
...
* daily deaths, median or reference scenario, 2020-12-01 on, wo DELP for this uptake
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "UCLA") size(small) row(1)) ///
subtitle("after 2020-12-01, without DELP for this uptake", size(small)) ///
ttext(0 21dec2020  "Dey"  0 20jan2021  "Bah" 0 19feb2021  "Esf" ///
0 21mar2021  "00"   0 21apr2021  "Ord" 0 22may2021  "Kho" ///
0 22jun2021  "Tir"  0 23jul2021  "Mor" 0 23Aug2021  "Sha" ///
0 23Sep2021  "Meh"  , size(small) color(black) placement(south))

graph save "graph 13 b COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on, wo DELP for this uptake.gph", replace
graph export "graph 13 b COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on, wo DELP for this uptake.pdf", replace
...
* daily deaths, median or reference scenario, Ordibeshet 1400 on, wo DELP for this uptake
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "SRIV" 6 "UCLA") size(small) row(1)) ///
subtitle("after Ordibeshet 1400, wo DELP for this uptake", size(small)) ///
ttext(0 21apr2021  "Ord" 0 22may2021  "Kho" ///
0 22jun2021  "Tir"  0 23jul2021  "Mor" 0 23Aug2021  "Sha" ///
0 23Sep2021  "Meh"  , size(small) color(black) placement(south))

graph save "graph 14 b COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on, wo DELP for this uptake.gph", replace
graph export "graph 14 b COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on, wo DELP for this uptake.pdf", replace
...
(line DayDeaUpSmA02S03 date, sort lcolor(black) lpattern(dash)) /// 7 IHME upper
...
(line DayDeaMeRaA17S00 date, sort lcolor(brown)) /// 17 "UCLA"
(line DayDeaLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 18 "UCLA"
(line DayDeaUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 19 "UCLA"
if date >= td(30nov2020) & date <= td(23Aug2021)  ///
, xtitle(Date) xlabel(#9, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 5 "IHME" 8 "IMPE" 11 "LANL" 14 "SRIV" 17 "UCLA") size(small) row(1)) ///
...
* daily deaths, median or reference scenario, 2020-12-01 on, CI, wo DELP for this uptake

twoway ///
(line DayDeaMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line DayDeaMeSmA02S01 date, sort lcolor(black)) /// 2 IHME mean
(line DayDeaLoSmA02S02 date, sort lcolor(black) lpattern(dash)) /// 3 IHME lower
(line DayDeaUpSmA02S03 date, sort lcolor(black) lpattern(dash)) /// 4 IHME upper
(line DayDeaMeRaA03S02 date, sort lcolor(magenta)) /// 5 IMPE mean
(line DayDeaLoRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 6 IMPE lower
(line DayDeaUpRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 7 IMPE upper
(line DayDeaMeRaA04S00 date, sort lcolor(gold)) /// 8 LANL mean
(line DayDeaLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 9 LANL lower
(line DayDeaUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 10 LANL upper
...
(line DayDeaMeRaA17S00 date, sort lcolor(brown)) /// 14 "UCLA"
(line DayDeaLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 15 "UCLA"
(line DayDeaUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 16 "UCLA
if date >= td(30nov2020) & date <= td(23Aug2021)  ///
, xtitle(Date) xlabel(#9, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "IHME" 5 "IMPE" 8 "LANL" 11 "SRIV" 14 "UCLA") size(small) row(1)) ///
subtitle("after 2020-12-01, with uncertainty, wo DELP for this uptake", size(small)) ///
note("Uncertainty limits: dashed curves") 

graph save "graph 15 b COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on, CI, wo DELP for this uptake.gph", replace
graph export "graph 15 b COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on, CI, wo DELP for this uptake.pdf", replace
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "IHME" 5 "IMPE" 8 "LANL" 11 "SRIV" 14 "UCLA") size(small) row(1)) ///
subtitle("after Ordibeshet 1400, with uncertainty, wo DELP for this uptake", size(small)) ///
note("Uncertainty limits: dashed curves") ///
ttext(0 21apr2021  "Ord" 0 22may2021  "Kho" ///
0 22jun2021  "Tir"  0 23jul2021  "Mor" 0 23Aug2021  "Sha" ///
0 23Sep2021  "Meh"  , size(small) color(black) placement(south))
...
(line DayDeaUpSmA02S03 date, sort lcolor(black) lpattern(dash)) /// 6 IHME upper
...
(line DayDeaMeRaA17S00 date, sort lcolor(brown)) /// 16 "UCLA"
(line DayDeaLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 17 "UCLA"
(line DayDeaUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 18 "UCLA"
if date >= td(21apr2021) & date <= td(23Sep2021) ///
, xtitle(Date) xlabel(22391 22422 22453 22484 22515 22546, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 4 "IHME" 7 "IMPE" 10 "LANL" 13 "SRIV" 16 "UCLA") size(small) row(1)) ///
subtitle("after Ordibeshet 1400, with uncertainty", size(small)) ///
note("Uncertainty limits: dashed curves") ///
ttext(0 21apr2021  "Ord" 0 22may2021  "Kho" ///
0 22jun2021  "Tir"  0 23jul2021  "Mor" 0 23Aug2021  "Sha" ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "IHME" 5 "IMPE" 8 "LANL" 11 "SRIV" 14 "UCLA") size(small) row(1)) ///
subtitle("after Ordibeshet 1400, with uncertainty, without DELP upper", size(small)) ///
note("Uncertainty limits: dashed curves") ///
ttext(0 21apr2021  "Ord" 0 22may2021  "Kho" ///
0 22jun2021  "Tir"  0 23jul2021  "Mor" 0 23Aug2021  "Sha" ///
0 23Sep2021  "Meh"  , size(small) color(black) placement(south))

graph save "graph 17 b COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on, CI, wo DLEP upper.gph", replace
graph export "graph 17 b COVID-19 daily deaths, Iran, reference scenarios, 2020-12-01 on, CI, wo DLEP upper.pdf", replace





* daily deaths, after Ordibeshet 1400, full scenarios, with uncertainty, without DELP upper

twoway ///
(line DayDeaMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line DayDeaMeRaA01S00 date, sort lcolor(red)) /// 2 "DELP" mean
(line DayDeaLoRaA01S00 date, sort lcolor(red) lpattern(dash)) /// 3 "DELP" lower
(line DayDeaMeSmA02S01 date, sort lcolor(black)) /// 4 IHME reference mean
(line DayDeaLoSmA02S02 date, sort lcolor(black) lpattern(dash)) /// 5 IHME reference lower
(line DayDeaUpSmA02S03 date, sort lcolor(black) lpattern(dash)) /// 6 IHME reference upper
(line DayDeaMeSmA02S02 date, sort lcolor(black) lwidth(thick) lpattern(tight_dot)) /// 7 IHME better mean
(line DayDeaMeSmA02S03 date, sort lcolor(black) lwidth(thick) lpattern(tight_dot)) /// 8 IHME worse mean
(line DayDeaMeRaA03S02 date, sort lcolor(magenta)) /// 9 IMPE reference mean
(line DayDeaLoRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 10 IMPE reference lower
(line DayDeaUpRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 11 IMPE reference upper
(line DayDeaMeRaA03S01 date, sort lcolor(magenta) lwidth(thick) lpattern(tight_dot)) /// 12 IMPE better mean
(line DayDeaMeRaA03S03 date, sort lcolor(magenta) lwidth(thick) lpattern(tight_dot)) /// 13 IMPE worse mean
(line DayDeaMeRaA04S00 date, sort lcolor(gold)) /// 14 LANL mean
(line DayDeaLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 15 LANL lower
(line DayDeaUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 16 LANL upper
(line DayDeaMeRaA05S00 date, sort lcolor(green)) /// 17 "SRIV" mean
(line DayDeaMeRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 18 "SRIV" lower
(line DayDeaMeRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 19 "SRIV" upper
(line DayDeaMeRaA17S00 date, sort lcolor(brown)) /// 20 "UCLA"
(line DayDeaLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 21 "UCLA"
(line DayDeaUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 22 "UCLA"
if date >= td(21apr2021) & date <= td(23Sep2021) ///
, xtitle(Date) xlabel(22391 22422 22453 22484 22515 22546, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, full scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
14 "LANL" 17 "SRIV" 20 "UCLA") size(small) row(4)) ///
...
graph save "graph 18 COVID-19 daily deaths, Iran, full scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 18 COVID-19 daily deaths, Iran, full scenarios, 2020-12-01 on, CI.pdf", replace




* daily deaths, after Ordibeshet 1400, full scenarios, with uncertainty, wo DELP for this uptake

twoway ///
(line DayDeaMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line DayDeaMeSmA02S01 date, sort lcolor(black)) /// 2 IHME reference mean
(line DayDeaLoSmA02S02 date, sort lcolor(black) lpattern(dash)) /// 3 IHME reference lower
(line DayDeaUpSmA02S03 date, sort lcolor(black) lpattern(dash)) /// 4 IHME reference upper
(line DayDeaMeSmA02S02 date, sort lcolor(black) lwidth(thick) lpattern(tight_dot)) /// 5 IHME better mean
(line DayDeaMeSmA02S03 date, sort lcolor(black) lwidth(thick) lpattern(tight_dot)) /// 6 IHME worse mean
(line DayDeaMeRaA03S02 date, sort lcolor(magenta)) /// 7 IMPE reference mean
(line DayDeaLoRaA03S02 date, sort lcolor(magenta) lwidth(thick) lpattern(tight_dot)) /// 8  IMPE reference lower
(line DayDeaUpRaA03S02 date, sort lcolor(magenta) lwidth(thick) lpattern(tight_dot)) /// 9  IMPE reference upper
(line DayDeaMeRaA03S01 date, sort lcolor(magenta)) /// 10 IMPE better mean
(line DayDeaMeRaA03S03 date, sort lcolor(magenta)) /// 11 IMPE worse mean
(line DayDeaMeRaA04S00 date, sort lcolor(gold)) /// 12 LANL mean
(line DayDeaLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL lower
(line DayDeaUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL upper
(line DayDeaMeRaA05S00 date, sort lcolor(green)) /// 15 "SRIV" mean
(line DayDeaMeRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 16 "SRIV" lower
(line DayDeaMeRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 17 "SRIV" upper
(line DayDeaMeRaA17S00 date, sort lcolor(brown)) /// 18 "UCLA"
(line DayDeaLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 19 "UCLA"
(line DayDeaUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 20 "UCLA"
if date >= td(21apr2021) & date <= td(23Sep2021) ///
, xtitle(Date) xlabel(22391 22422 22453 22484 22515 22546, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, full scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "IHME reference mean" 3 "IHME ref uncertainty" 5 "IHME better and worse" ///
7 "IMPE reference" 8 "IMPE ref uncertainty" 10 "IMPE better and worse" ///
12 "LANL" 15 "SRIV" 18 "UCLA") size(small) row(4)) ///
subtitle("after Ordibeshet 1400, full scenarios, with uncertainty, wo DELP for this uptake", size(small)) ///
note("Uncertainty limits: dashed (– – –) curves; Better and worse scenarios: tight dot (|||||) curves") ///
ttext(0 21apr2021  "Ord" 0 22may2021  "Kho" ///
0 22jun2021  "Tir"  0 23jul2021  "Mor" 0 23Aug2021  "Sha" ///
0 23Sep2021  "Meh"  , size(small) color(black) placement(south))

graph save "graph 18 b COVID-19 daily deaths, Iran, full scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 18 b COVID-19 daily deaths, Iran, full scenarios, 2020-12-01 on, CI.pdf", replace
...
(line DayCasMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(22nov2019) & date <= td(22Dec2021) ///
, xtitle(Date) xlabel(21875 21905 21935 21965 21994 22025 22056 22087 22118 22149 22180 ///
22210 22240 22270 22300 22330 22360 22391 22422 22453 22484 22515 22546 22576 22606 22636, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
* daily cases, median or reference scenario, wo DELP for this uptake

twoway ///
(line DayCasMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN"
(line DayCasMeRaA02S01 date, sort lcolor(black)) /// 2 "IHME"
(line DayCasMeRaA03S02 date, sort lcolor(magenta)) /// 3 "IMPE"
(line DayCasMeRaA04S00 date, sort lcolor(gold)) /// 4 "LANL"
(line DayCasMeRaA05S00 date, sort lcolor(green)) /// 5 "SRIV"
(line DayCasMeRaA17S00 date, sort lcolor(brown)) /// 6 "UCLA"
if date >= td(22nov2019) & date <= td(22Dec2021) ///
, xtitle(Date) xlabel(21875 21905 21935 21965 21994 22025 22056 22087 22118 22149 22180 ///
22210 22240 22270 22300 22330 22360 22391 22422 22453 22484 22515 22546 22576 22606 22636, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
graph save "graph 21 b COVID-19 daily cases, Iran, reference scenarios, wo DELP for this uptake.gph", replace
graph export "graph 21 b COVID-19 daily cases, Iran, reference scenarios, wo DELP for this uptake.pdf", replace
...
(line DayCasMeRaA00S00_CF2 date, sort lcolor(cyan) lpattern(tight_dot)) /// 2 "JOHN" CF2
(line DayCasMeRaA00S00_CF5 date, sort lcolor(cyan) lpattern(tight_dot)) /// 3 "JOHN" CF5
...
(line DayCasMeRaA17S00 date, sort lcolor(brown)) /// 9 "UCLA"
if date >= td(22nov2019) & date <= td(22Dec2021) ///
, xtitle(Date) xlabel(21875 21905 21935 21965 21994 22025 22056 22087 22118 22149 22180 ///
22210 22240 22270 22300 22330 22360 22391 22422 22453 22484 22515 22546 22576 22606 22636, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
graph save "graph 22 COVID-19 daily cases, Iran, reference scenarios, w CF.gph", replace
graph export "graph 22 COVID-19 daily cases, Iran, reference scenarios, w CF.pdf", replace
...
* daily cases, median or reference scenario, 2020-12-01 on, wo DELP for this uptake
...
graph save "graph 23 b COVID-19 daily cases, Iran, reference scenarios, 2020-12-01 on.gph", replace
graph export "graph 23 b COVID-19 daily cases, Iran, reference scenarios, 2020-12-01 on.pdf", replace
...
* daily cases, median or reference scenario, Ordibeshet 1400 on, wo DELP for this uptake
...
graph save "graph 24 b COVID-19 daily cases, Iran, reference scenarios, 2020-12-01 on, wo DELP for this uptake.gph", replace
graph export "graph 24 b COVID-19 daily cases, Iran, reference scenarios, 2020-12-01 on, wo DELP for this uptake.pdf", replace
...
(line DayCasMeRaA17S00 date, sort lcolor(brown)) /// 17 "UCLA" mean
(line DayCasMeRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 18 "UCLA" lower
(line DayCasMeRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 19 "UCLA" upper
if date >= td(30nov2020) & date <= td(23Aug2021)  ///
, xtitle(Date) xlabel(#9, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases) title("COVID-19 daily cases, Iran, reference scenarios", size(medium)) ///
...
* daily cases, median or reference scenario, 2020-12-01 on, CI, wo DELP for this uptake

twoway ///
(line DayCasMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line DayCasMeRaA02S01 date, sort lcolor(black)) /// 2 IHME mean
(line DayCasLoRaA02S01 date, sort lcolor(black) lpattern(dash)) /// 3 IHME lower
(line DayCasUpRaA02S01 date, sort lcolor(black) lpattern(dash)) /// 4 IHME upper
(line DayCasMeRaA03S02 date, sort lcolor(magenta)) /// 5 IMPE mean
(line DayCasLoRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 6  IMPE lower
(line DayCasUpRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 7  IMPE upper
(line DayCasMeRaA04S00 date, sort lcolor(gold)) /// 8 LANL mean
(line DayCasLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 9  LANL lower
(line DayCasUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 10 LANL upper
...
(line DayCasMeRaA17S00 date, sort lcolor(brown)) /// 14 "UCLA" mean
(line DayCasMeRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 15 "UCLA" lower
(line DayCasMeRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 16 "UCLA" upper
if date >= td(21apr2021) & date <= td(23Sep2021) ///
, xtitle(Date) xlabel(22391 22422 22453 22484 22515 22546, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
...
graph save "graph 26 b COVID-19 daily cases, Iran, reference scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 26 b COVID-19 daily cases, Iran, reference scenarios, 2020-12-01 on, CI.pdf", replace
...
(line DayCasMeRaA17S00 date, sort lcolor(brown)) /// 20 "UCLA" mean
(line DayCasMeRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 21 "UCLA" lower
(line DayCasMeRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 22 "UCLA" upper
if date >= td(21apr2021) & date <= td(23Sep2021) ///
, xtitle(Date) xlabel(22391 22422 22453 22484 22515 22546, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
...
* daily cases, after Ordibeshet 1400, full scenarios, with uncertainty, wo DELP for this uptake

twoway ///
(line DayCasMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line DayCasMeRaA02S01 date, sort lcolor(black)) /// 2 IHME reference mean
(line DayCasLoRaA02S01 date, sort lcolor(black) lpattern(dash)) /// 3 IHME reference lower
(line DayCasUpRaA02S01 date, sort lcolor(black) lpattern(dash)) /// 4 IHME reference upper
(line DayCasMeRaA02S02 date, sort lcolor(black) lwidth(thick) lpattern(tight_dot)) /// 5 IHME better mean
(line DayCasMeRaA02S03 date, sort lcolor(black) lwidth(thick) lpattern(tight_dot)) /// 6 IHME worse mean
(line DayCasMeRaA03S02 date, sort lcolor(magenta)) /// 7 IMPE reference mean
(line DayCasLoRaA03S02 date, sort lcolor(magenta) lwidth(thick) lpattern(tight_dot)) /// 8 IMPE reference lower
(line DayCasUpRaA03S02 date, sort lcolor(magenta) lwidth(thick) lpattern(tight_dot)) /// 9 IMPE reference upper
(line DayCasMeRaA03S01 date, sort lcolor(magenta)) /// 10 IMPE better mean
(line DayCasMeRaA03S03 date, sort lcolor(magenta)) /// 11 IMPE worse mean
(line DayCasMeRaA04S00 date, sort lcolor(gold)) /// 12 LANL mean
(line DayCasLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL lower
(line DayCasUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL upper
...
(line DayCasMeRaA17S00 date, sort lcolor(brown)) /// 18 "UCLA" mean
(line DayCasMeRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 19 "UCLA" lower
(line DayCasMeRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 20 "UCLA" upper
if date >= td(21apr2021) & date <= td(23Sep2021) ///
, xtitle(Date) xlabel(22391 22422 22453 22484 22515 22546, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
...
graph save "graph 27 b COVID-19 daily cases, Iran, full scenarios, 2020-12-01 on, CI, wo DELP for this uptake.gph", replace
graph export "graph 27 b COVID-19 daily cases, Iran, full scenarios, 2020-12-01 on, CI, wo DELP for this uptake.pdf", replace
...
(line TotDeaMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
...
twoway ///
(line TotDeaMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN"
(line TotDeaMeRaA00S00_CF2 date, sort lcolor(cyan) lpattern(tight_dot)) /// 2 "JOHN" CF2
(line TotDeaMeRaA00S00_CF5 date, sort lcolor(cyan) lpattern(tight_dot)) /// 3 "JOHN" CF5
(line TotDeaMeRaA01S00 date, sort lcolor(red)) /// 4 "DELP"
(line TotDeaMeSmA02S01 date, sort lcolor(black)) /// 5 "IHME"
(line TotDeaMeRaA03S02 date, sort lcolor(magenta)) /// 6 "IMPE"
(line TotDeaMeRaA04S00 date, sort lcolor(gold)) /// 7 "LANL"
(line TotDeaMeRaA05S00 date, sort lcolor(green)) /// 8 "SRIV"
(line TotDeaMeRaA17S00 date, sort lcolor(brown)) /// 9 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
graph save "graph 32 COVID-19 total deaths, Iran, reference scenarios, w CF.gph", replace
graph export "graph 32 COVID-19 total deaths, Iran, reference scenarios, w CF.pdf", replace
...
(line TotDeaMeRaA17S00 date, sort lcolor(brown)) /// 17 "UCLA" mean
(line TotDeaLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 18 "UCLA" lower
(line TotDeaUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 19 "UCLA" upper
if date >= td(01jan2021) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths) title("COVID-19 total deaths, Iran, reference scenarios", size(medium)) ///
...
(line TotDeaMeRaA00S00_CF2 date, sort lcolor(cyan) lpattern(tight_dot)) /// 2 "JOHN" CF2
(line TotDeaMeRaA00S00_CF5 date, sort lcolor(cyan) lpattern(tight_dot)) /// 3 "JOHN" CF5
(line TotDeaMeRaA01S00 date, sort lcolor(red)) /// 4 DELP mean
(line TotDeaLoRaA01S00 date, sort lcolor(red) lpattern(dash)) /// 5 DELP lower
(line TotDeaUpRaA01S00 date, sort lcolor(red) lpattern(dash)) /// 6 DELP upper
(line TotDeaMeSmA02S01 date, sort lcolor(black)) /// 7 IHME mean
(line TotDeaLoSmA02S01 date, sort lcolor(black) lpattern(dash)) /// 8 IHME lower
(line TotDeaUpSmA02S01 date, sort lcolor(black) lpattern(dash)) /// 9 IHME upper
(line TotDeaMeRaA03S02 date, sort lcolor(magenta)) /// 10 IMPE mean
(line TotDeaLoRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 11 IMPE lower
(line TotDeaUpRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 12 IMPE upper
(line TotDeaMeRaA04S00 date, sort lcolor(gold)) /// 13 LANL mean
(line TotDeaLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL lower
(line TotDeaUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 15 LANL upper
(line TotDeaMeRaA05S00 date, sort lcolor(green)) /// 16 "SRIV" mean
(line TotDeaLoRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 17 "SRIV" lower
(line TotDeaUpRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 18 "SRIV" upper
(line TotDeaMeRaA17S00 date, sort lcolor(brown)) /// 19 "UCLA" mean
(line TotDeaLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 20 "UCLA" lower
(line TotDeaUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 21 "UCLA" upper
if date >= td(01jan2021) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths) title("COVID-19 total deaths, Iran, reference scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "CF 2" 3 "CF 5" 4 "DELP" 7 "IHME" 10 "IMPE" 13 "LANL" 16 "SRIV" 19 "UCLA") size(small) row(1)) ///
note("Uncertainty limits: dashed curves") ///
subtitle("after 2020-12-01, with correction factors 2 and 5, with uncertainty", size(small))

graph save "graph 35 COVID-19 total deaths, Iran, reference scenarios, 2020-12-01 on, CI, w CF.gph", replace
graph export "graph 35 COVID-19 total deaths, Iran, reference scenarios, 2020-12-01 on, CI, w CF.pdf", replace
...
(line TotCasMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
twoway ///
(line TotCasMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN"
(line TotCasMeRaA00S00_CF2 date, sort lcolor(cyan) lpattern(tight_dot)) /// 2 "JOHN" CF2
(line TotCasMeRaA00S00_CF5 date, sort lcolor(cyan) lpattern(tight_dot)) /// 3 "JOHN" CF5
(line TotCasMeRaA01S00 date, sort lcolor(red)) /// 4 "DELP"
(line TotCasMeRaA02S01 date, sort lcolor(black)) /// 5 "IHME"
(line TotCasMeRaA03S02 date, sort lcolor(magenta)) /// 6 "IMPE"
(line TotCasMeRaA04S00 date, sort lcolor(gold)) /// 7 "LANL"
(line TotCasMeRaA05S00 date, sort lcolor(green)) /// 8 "SRIV"
(line TotCasMeRaA17S00 date, sort lcolor(brown)) /// 9 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases) title("COVID-19 total cases, Iran, reference scenarios", size(medium)) /// 
...
graph save "graph 42 COVID-19 total cases, Iran, reference scenarios, w CF.gph", replace
graph export "graph 42 COVID-19 total cases, Iran, reference scenarios, w CF.pdf", replace
...
graph save "graph 44 COVID-19 total cases, Iran, reference scenarios, 2020-12-01 on, w CF.gph", replace
graph export "graph 44 COVID-19 total cases, Iran, reference scenarios, 2020-12-01 on, w CF.pdf", replace
...
(line TotCasMeRaA17S00 date, sort lcolor(brown)) /// 17 "UCLA" mean
(line TotCasLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 18 "UCLA" lower
(line TotCasUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 19 "UCLA" upper
if date >= td(01jan2021) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases) title("COVID-19 total cases, Iran, reference scenarios", size(medium)) ///
...
(line TotCasMeRaA00S00_CF5 date, sort lcolor(cyan) lpattern(tight_dot)) /// 3 "JOHN" CF5
(line TotCasMeRaA01S00 date, sort lcolor(red)) /// 4 "DELP"
(line TotCasLoRaA01S00 date, sort lcolor(red) lpattern(dash)) /// 5 "DELP"
(line TotCasUpRaA01S00 date, sort lcolor(red) lpattern(dash)) /// 6 "DELP"
...
(line TotCasMeRaA03S02 date, sort lcolor(magenta)) /// 10 IMPE mean
(line TotCasLoRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 11 IMPE lower
(line TotCasUpRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 12 IMPE upper
(line TotCasMeRaA04S00 date, sort lcolor(gold)) /// 13 LANL mean
(line TotCasLoRaA04S00 date, sort lcolor(gold)  lpattern(dash)) /// 14 LANL lower
(line TotCasUpRaA04S00 date, sort lcolor(gold)  lpattern(dash)) /// 15 LANL upper
(line TotCasMeRaA05S00 date, sort lcolor(green)) /// 16 "SRIV" mean
(line TotCasMeRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 17 "SRIV" lower
(line TotCasMeRaA05S00 date, sort lcolor(green) lpattern(dash)) /// 18 "SRIV" upper
(line TotCasMeRaA17S00 date, sort lcolor(brown)) /// 19 "UCLA" mean
(line TotCasLoRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 20 "UCLA" lower
(line TotCasUpRaA17S00 date, sort lcolor(brown) lpattern(dash)) /// 21 "UCLA" upper
if date >= td(01jan2021) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases) title("COVID-19 total cases, Iran, reference scenarios", size(medium)) ///
...
graph save "graph 46 COVID-19 total cases, Iran, reference scenarios, 2020-12-01 on, CI, w CF.gph", replace
graph export "graph 46 COVID-19 total cases, Iran, reference scenarios, 2020-12-01 on, CI, w CF.pdf", replace
...
(line DayCfrMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
twoway ///
(line DayActMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN" 
(line DayActMeRaA01S00 date, sort lcolor(red)) /// 2 "DELP" 
(line DayActMeRaA07S09 date, sort lcolor(black)) /// 3 "GHAN" 
(line DayActMeRaA06S01 date, sort lcolor(red) lpattern(dash)) /// 4 "SOLT S1"
(line DayActMeRaA06S02 date, sort lcolor(blue) lpattern(dash)) /// 5 "SOLT S2"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily active cases) title("COVID-19 daily active cases, Iran", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "GHAN" 4 "SOLT S1" 5 "SOLT S2") size(small) row(1)) ///
subtitle("  .", size(small) color(white))
...
(line DayActMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN" 
(line DayActMeRaA01S00 date, sort lcolor(red)) /// 2 "DELP" 
(line DayActMeRaA06S01 date, sort lcolor(red) lpattern(dash)) /// 3 "SOLT S1"
(line DayActMeRaA06S02 date, sort lcolor(blue) lpattern(dash)) /// 4 "SOLT S2"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily active cases) title("COVID-19 daily active cases, Iran", size(medium)) /// 
...
graph save "graph 63 COVID-19 daily active cases wo GHAN Hijri.gph", replace
graph export "graph 63 COVID-19 daily active cases wo GHAN Hijri.pdf", replace
...
graph save "graph 64 COVID-19 daily active cases wo GHAN 2020-12-01 on.gph", replace
graph export "graph 64 COVID-19 daily active cases wo GHAN 2020-12-01 on.pdf", replace
...
* daily hospital-related outcomes, DELP, IHME, IMPE, wo IHME Bed need, IMPE Hosp demand, 2020-12-01 on 
/*
twoway ///
(line DayHosMeRaA01S00 date, sort lcolor(red)  lwidth(thick)) /// 1 DELP Hospitalized (Daily Cases Active Hospitalized Mean DELP S0)
(line DayVenMeRaA01S00 date, sort lcolor(red) lpattern(dash)  lwidth(thick)) /// 2 DELP Ventilated (Daily Cases Active Ventilated Mean DELP S0)
...
legend(order(1 "DELP Hospitalized" 2 "DELP Ventilated" 3 "IHME ICU need" 4 "IHME Vent need" ///
5 "IHME Admissions" 6 "IHME ICU new" 7 "IMPE Hosp incidence" 8 "IMPE ICU demand" 9 "IMPE ICU incidence") rows(3) size(small)) ///
subtitle("after 2020-12-01, without IHME Bed need, IMPE Hosp demand", size(small))
...
(line DayCTDMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
(line DayCTDMeRaA17S00 date, sort lcolor(brown)) /// 11 "UCLA"
if date >= td(21apr2021) & date <= td(23Sep2021) ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 6 "IMPE" 9 "LANL" 10 "SRIV" 11 "UCLA") size(small) row(1)) ///
...
(line TotCTDMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
(line DayDERMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
(line DayCERMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
(line TotDERMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
(line TotCERMeRaA17S00 date, sort lcolor(brown)) /// 7 "UCLA"
if date >= td(01jan2020) & date <= td(01jan2022) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
