...
(line DayDeaLoSmA02S01 date, sort lcolor(black) lpattern(dash)) /// 3 IHME lower
(line DayDeaUpSmA02S01 date, sort lcolor(black) lpattern(dash)) /// 4 IHME upper
...
(line DayDeaLoSmA02S01 date, sort lcolor(black) lpattern(dash)) /// 5 IHME reference lower
(line DayDeaUpSmA02S01 date, sort lcolor(black) lpattern(dash)) /// 6 IHME reference upper
...
(line DayDeaLoSmA02S01 date, sort lcolor(black) lpattern(dash)) /// 3 IHME reference lower
(line DayDeaUpSmA02S01 date, sort lcolor(black) lpattern(dash)) /// 4 IHME reference upper
