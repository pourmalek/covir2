...
di in red "Wait until downloading and unzipping SRIV ReCOVER-COVID-19-master.zip below is complete."
...
gen DayCfrMeSmA05S01V02 = 100 * DayDeaMeSmA05S01V02 / DayCasMeSmA05S01V02
gen DayCfrMeSmA05S02V02 = 100 * DayDeaMeSmA05S02V02 / DayCasMeSmA05S02V02
gen DayCfrMeSmA05S03V02 = 100 * DayDeaMeSmA05S03V02 / DayCasMeSmA05S03V02
gen DayCfrMeSmA05S04V02 = 100 * DayDeaMeSmA05S04V02 / DayCasMeSmA05S04V02
gen DayCfrMeSmA05S05V02 = 100 * DayDeaMeSmA05S05V02 / DayCasMeSmA05S05V02
gen DayCfrMeSmA05S06V02 = 100 * DayDeaMeSmA05S06V02 / DayCasMeSmA05S06V02
gen DayCfrMeSmA05S07V02 = 100 * DayDeaMeSmA05S07V02 / DayCasMeSmA05S07V02
gen DayCfrMeSmA05S08V02 = 100 * DayDeaMeSmA05S08V02 / DayCasMeSmA05S08V02
gen DayCfrMeSmA05S09V02 = 100 * DayDeaMeSmA05S09V02 / DayCasMeSmA05S09V02
gen DayCfrMeSmA05S10V02 = 100 * DayDeaMeSmA05S10V02 / DayCasMeSmA05S10V02
gen DayCfrMeSmA05S11V02 = 100 * DayDeaMeSmA05S11V02 / DayCasMeSmA05S11V02
gen DayCfrMeSmA05S12V02 = 100 * DayDeaMeSmA05S12V02 / DayCasMeSmA05S12V02
gen DayCfrMeSmA05S13V02 = 100 * DayDeaMeSmA05S13V02 / DayCasMeSmA05S13V02
gen DayCfrMeSmA05S14V02 = 100 * DayDeaMeSmA05S14V02 / DayCasMeSmA05S14V02
gen DayCfrMeSmA05S15V02 = 100 * DayDeaMeSmA05S15V02 / DayCasMeSmA05S15V02
gen DayCfrMeSmA05S16V02 = 100 * DayDeaMeSmA05S16V02 / DayCasMeSmA05S16V02
gen DayCfrMeSmA05S17V02 = 100 * DayDeaMeSmA05S17V02 / DayCasMeSmA05S17V02
gen DayCfrMeSmA05S18V02 = 100 * DayDeaMeSmA05S18V02 / DayCasMeSmA05S18V02

label var DayCfrMeSmA05S01V02 "Daily CFR Smoothed SRIV S01 ie S1P1"
label var DayCfrMeSmA05S02V02 "Daily CFR Smoothed SRIV S02 ie S1P2"
label var DayCfrMeSmA05S03V02 "Daily CFR Smoothed SRIV S03 ie S1P3"
label var DayCfrMeSmA05S04V02 "Daily CFR Smoothed SRIV S04 ie S1P4"
label var DayCfrMeSmA05S05V02 "Daily CFR Smoothed SRIV S05 ie S1P5"
label var DayCfrMeSmA05S06V02 "Daily CFR Smoothed SRIV S06 ie S1P6"
label var DayCfrMeSmA05S07V02 "Daily CFR Smoothed SRIV S07 ie S2P1"
label var DayCfrMeSmA05S08V02 "Daily CFR Smoothed SRIV S08 ie S2P2"
label var DayCfrMeSmA05S09V02 "Daily CFR Smoothed SRIV S09 ie S2P3"
label var DayCfrMeSmA05S10V02 "Daily CFR Smoothed SRIV S10 ie S2P4"
label var DayCfrMeSmA05S11V02 "Daily CFR Smoothed SRIV S11 ie S2P5"
label var DayCfrMeSmA05S12V02 "Daily CFR Smoothed SRIV S12 ie S2P6"
label var DayCfrMeSmA05S13V02 "Daily CFR Smoothed SRIV S13 ie S3P1"
label var DayCfrMeSmA05S14V02 "Daily CFR Smoothed SRIV S14 ie S3P2"
label var DayCfrMeSmA05S15V02 "Daily CFR Smoothed SRIV S15 ie S3P3"
label var DayCfrMeSmA05S16V02 "Daily CFR Smoothed SRIV S16 ie S3P4"
label var DayCfrMeSmA05S17V02 "Daily CFR Smoothed SRIV S17 ie S3P5"
label var DayCfrMeSmA05S18V02 "Daily CFR Smoothed SRIV S18 ie S3P6"
...
graph save "graph 01 COVID-19 total deaths, default scenario, Iran, SRIV.gph", replace
// graph export "graph 01 COVID-19 total deaths, default scenario, Iran, SRIV.pdf", replace
...
graph save "graph 02 COVID-19 daily deaths raw, default scenario, Iran, SRIV.gph", replace
// graph export "graph 02 COVID-19 daily deaths raw, default scenario, Iran, SRIV.pdf", replace
...
graph save "graph 03 COVID-19 daily deaths smoothed, default scenario, Iran, SRIV.gph", replace
// graph export "graph 03 COVID-19 daily deaths smoothed, default scenario, Iran, SRIV.pdf", replace
...
graph save "graph 04 COVID-19 weekly deaths, default scenario, Iran, SRIV.gph", replace
// graph export "graph 04 COVID-19 weekly deaths, default scenario, Iran, SRIV.pdf", replace
...
twoway ///
(line DayCfrMeSmA05S02V02 date, sort lcolor(green)) ///
, xtitle(Date) xlabel(#4, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cfr) title("COVID-19 daily CFR, Iran, SRIV, default scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 

graph save "graph 05 COVID-19 daily CFR, default scenario, Iran, SRIV.gph", replace
// graph export "graph 05 COVID-19 daily CFR, default scenario, Iran, SRIV.pdf", replace
...
graph save "graph 06 COVID-19 daily deaths, 6 current scenarios, Iran, SRIV.gph", replace
// graph export "graph 06 COVID-19 daily deaths, 6 current scenarios, Iran, SRIV.pdf", replace
...
graph save "graph 07 COVID-19 daily deaths, 6 current scenarios, raw, Iran, SRIV.gph", replace
// graph export "graph 07 COVID-19 daily deaths, 6 current scenarios, raw, Iran, SRIV.pdf", replace
...
graph save "graph 08 COVID-19 daily deaths, 6 released scenarios, Iran, SRIV.gph", replace
// graph export "graph 08 COVID-19 daily deaths, 6 released scenarios, Iran, SRIV.pdf", replace
...
graph save "graph 09 COVID-19 daily deaths, 6 released scenarios, raw, Iran, SRIV.gph", replace
// graph export "graph 09 COVID-19 daily deaths, 6 released scenarios, raw, Iran, SRIV.pdf", replace
...
graph save "graph 10 COVID-19 daily deaths, 6 restricted scenarios, Iran, SRIV.gph", replace
// graph export "graph 10 COVID-19 daily deaths, 6 restricted scenarios, Iran, SRIV.pdf", replace
...
graph save "graph 11 COVID-19 daily deaths, 6 restricted scenarios, raw, Iran, SRIV.gph", replace
// graph export "graph 11 COVID-19 daily deaths, 6 restricted scenarios, raw, Iran, SRIV.pdf", replace
...
graph save "graph 12 COVID-19 daily deaths, default of 3 scenario groups, Iran, SRIV.gph", replace
// graph export "graph 12 COVID-19 daily deaths, default of 3 scenario groups, Iran, SRIV.pdf", replace
...
graph save "graph 13 COVID-19 daily deaths, default of 3 scenario groups, raw, Iran, SRIV.gph", replace
// graph export "graph 13 COVID-19 daily deaths, default of 3 scenario groups, raw, Iran, SRIV.pdf", replace
...
graph save "graph 14 COVID-19 total cases, default scenario, Iran, SRIV.gph", replace
// graph export "graph 14 COVID-19 total cases, default scenario, Iran, SRIV.pdf", replace
...
graph save "graph 15 COVID-19 daily cases raw, default scenario, Iran, SRIV.gph", replace
// graph export "graph 15 COVID-19 daily cases raw, default scenario, Iran, SRIV.pdf", replace
...
graph save "graph 16 COVID-19 daily cases smoothed, default scenario, Iran, SRIV.gph", replace
// graph export "graph 16 COVID-19 daily cases smoothed, default scenario, Iran, SRIV.pdf", replace
...
graph save "graph 17 COVID-19 weekly cases, default scenario, Iran, SRIV.gph", replace
// graph export "graph 17 COVID-19 weekly cases, default scenario, Iran, SRIV.pdf", replace
...
graph save "graph 18 COVID-19 daily cases, 6 current scenarios, Iran, SRIV.gph", replace
// graph export "graph 18 COVID-19 daily cases, 6 current scenarios, Iran, SRIV.pdf", replace
...
graph save "graph 19 COVID-19 daily cases, 6 current scenarios, raw, Iran, SRIV.gph", replace
// graph export "graph 19 COVID-19 daily cases, 6 current scenarios, raw, Iran, SRIV.pdf", replace
...
graph save "graph 20 COVID-19 daily cases, 6 released scenarios, Iran, SRIV.gph", replace
// graph export "graph 20 COVID-19 daily cases, 6 released scenarios, Iran, SRIV.pdf", replace
...
graph save "graph 21 COVID-19 daily cases, 6 released scenarios, raw, Iran, SRIV.gph", replace
// graph export "graph 21 COVID-19 daily cases, 6 released scenarios, raw, Iran, SRIV.pdf", replace
...
graph save "graph 22 COVID-19 daily cases, 6 restricted scenarios, Iran, SRIV.gph", replace
// graph export "graph 22 COVID-19 daily cases, 6 restricted scenarios, Iran, SRIV.pdf", replace
...
graph save "graph 23 COVID-19 daily cases, 6 restricted scenarios, raw, Iran, SRIV.gph", replace
// graph export "graph 23 COVID-19 daily cases, 6 restricted scenarios, raw, Iran, SRIV.pdf", replace
...
graph save "graph 24 COVID-19 daily cases, default of 3 scenario groups, Iran, SRIV.gph", replace
// graph export "graph 24 COVID-19 daily cases, default of 3 scenario groups, Iran, SRIV.pdf", replace
...
graph save "graph 25 COVID-19 daily cases, default of 3 scenario groups, raw, Iran, SRIV.gph", replace
// graph export "graph 25 COVID-19 daily cases, default of 3 scenario groups, raw, Iran, SRIV.pdf", replace
