...
else if regexm(c(os),"Windows") == 1 [do that] use "$pathcovir2\SRIV\scenario_reshape.dta", clear
...
else if regexm(c(os),"Windows") == merge m:1 loc_grand_name date using "$pathcovir2\SRIV\Iran SRIV weekly.dta"
