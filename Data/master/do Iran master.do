...
Edit the contents within " " of the line below - if needed - beneath ****** set path based on local operating system ****** ,,, 
...
,,, to reflect the location of directory /data/ or \data\ on your local machine.
