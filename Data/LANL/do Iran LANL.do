...
graph save "graph 3 COVID-19 daily CFR, Iran, LANL.gph", replace
// graph export "graph 3 COVID-19 daily CFR, Iran, LANL.pdf", replace
...
graph save "graph 4 COVID-19 daily CFR, Iran, LANL, 01dec2020 on.gph", replace
// graph export "graph 4 COVID-19 daily CFR, Iran, LANL, 01dec2020 on.pdf", replace
...
summ DayDeaMeRaA04S00V02 if date > td(01feb2021) & date < td(30apr2021)

gen DayDeaMeRaA04S00V02P4V = r(max)

summ date if DayDeaMeRaA04S00V02 == DayDeaMeRaA04S00V02P4V & date > td(01feb2021) & date < td(30apr2021)
...
label var DayDeaMeRaA04S00V02P8V "DayDeaMeRaA04S00V02 End date Value"

gen DayDeaLoRaA04S00V02P8V = r(max)

label var DayDeaLoRaA04S00V02P8V "DayDeaLoRaA04S00V02 End date Value"

gen DayDeaUpRaA04S00V02P8V = r(max)

label var DayDeaUpRaA04S00V02P8V "DayDeaUpRaA04S00V02 End date Value"
...
summ DayCasMeRaA04S00V02 if date > td(01jul2020) & date < td(30jul2020)

gen DayCasMeRaA04S00V02P2V = r(max)

summ date if DayCasMeRaA04S00V02 == DayCasMeRaA04S00V02P2V & date > td(01jul2020) & date < td(30jul2020)
...
summ DayCasMeRaA04S00V02 if date > td(01jan2021) & date < td(30apr2021)

gen DayCasMeRaA04S00V02P4V = r(max)

summ date if DayCasMeRaA04S00V02 == DayCasMeRaA04S00V02P4V & date > td(01jan2021) & date < td(30apr2021)
...
label var DayCasMeRaA04S00V02P8V "DayCasMeRaA04S00V02 End date Value"

gen DayCasLoRaA04S00V02P8V = r(max)

label var DayCasLoRaA04S00V02P8V "DayCasLoRaA04S00V02 End date Value"

gen DayCasUpRaA04S00V02P8V = r(max)

label var DayCasUpRaA04S00V02P8V "DayCasUpRaA04S00V02 End date Value"
