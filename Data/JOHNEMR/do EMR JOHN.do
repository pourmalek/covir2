...
foreach l of local levels {
	...
	tabstat DayCfrMeRaA00S00V00 if loc_grand_name == "`l'" & DayCfrMeRaA00S00V00 >= 0, stat(mean p50 min max) varwidth(32)
...
qui graph save "graph 2 COVID-19 daily CFR, `l', Johns Hopkins.gph", replace
qui graph export "graph 2 COVID-19 daily CFR, `l', Johns Hopkins.pdf", replace
