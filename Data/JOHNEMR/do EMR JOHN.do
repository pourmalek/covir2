...
foreach l of local levels {
	...
	summ DayCbDMeRaA00S00V00_`l' if loc_grand_name == "`l'"
	di "                            "
...
qui graph save "graph 3 COVID-19 daily CFR, `l', Johns Hopkins.gph", replace
qui graph export "graph 3 COVID-19 daily CFR, `l', Johns Hopkins.pdf", replace
...
qui graph save "graph 4 COVID-19 daily CFR, smoothed `l', Johns Hopkins.gph", replace
qui graph export "graph 4 COVID-19 daily CFR, smoothed `l', Johns Hopkins.pdf", replace
