...
// replace DayCfrLoRaA01S00V03 = 0 if DayDeaLoRaA01S00V03 == 0 & DayCasLoRaA01S00V03 == 0 // not visually informative
...
graph save "graph 3 COVID-19 daily cases, Iran, DELP wo CI.gph", replace
// graph export "graph 3 COVID-19 daily cases, Iran, DELP wo CI.pdf", replace
...
graph save "graph 4 COVID-19 daily cases, Iran, DELP with CI.gph", replace
// graph export "graph 4 COVID-19 daily cases, Iran, DELP with CI.pdf", replace
