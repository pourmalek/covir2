...
summ DayDeaMeRaA01S00V03 if date > td(01mar2021) & date < td(30mar2021) // 5703

list date if DayDeaMeRaA01S00V03 > 5702.9 & date > td(01mar2021) & date < td(30mar2021) // 21Mar2021 

list DayDeaLoRaA01S00V03 if date == td(21Mar2021) // 5674 
list DayDeaUpRaA01S00V03 if date == td(21Mar2021) // 5732

* lowest point in start, codebook date // 10feb2021,15apr2021

list DayDeaMeRaA01S00V03 if date == td(15feb2021) // 204
list DayDeaLoRaA01S00V03 if date == td(15feb2021) // 96
list DayDeaUpRaA01S00V03 if date == td(15feb2021) // 287


* lowest point at the end, codebook date // 10feb2021,15apr2021

list DayDeaMeRaA01S00V03 if date == td(15apr2021) // 690
list DayDeaLoRaA01S00V03 if date == td(15apr2021) // 668
list DayDeaUpRaA01S00V03 if date == td(15apr2021) // 712
...
summ DayCasMeRaA01S00V03 if date > td(01mar2021) & date < td(30mar2021) // 586880

list date if DayCasMeRaA01S00V03 > 586879.9 & date > td(01mar2021) & date < td(30mar2021) // 17Mar2021 

list DayCasLoRaA01S00V03 if date == td(17Mar2021) // 585558 
list DayCasUpRaA01S00V03 if date == td(17Mar2021) // 588202

* lowest point in start, codebook date // 10feb2021,15apr2021

list DayCasMeRaA01S00V03 if date == td(15feb2021) // 21322
list DayCasLoRaA01S00V03 if date == td(15feb2021) // 17658
list DayCasUpRaA01S00V03 if date == td(15feb2021) // 24986


* lowest point at the end, codebook date // 10feb2021,15apr2021

list DayCasMeRaA01S00V03 if date == td(15apr2021) // 41083
list DayCasLoRaA01S00V03 if date == td(15apr2021) // 40109
list DayCasUpRaA01S00V03 if date == td(15apr2021) // 42057
