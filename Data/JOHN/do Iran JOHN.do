...
graph save "graph 2 COVID-19 daily deaths, Iran, Johns Hopkins 2.gph", replace
// graph export "graph 2 COVID-19 daily deaths, Iran, Johns Hopkins 2.pdf", replace
...
graph save "graph 4 COVID-19 daily CFR, Iran, Johns Hopkins.gph", replace
// graph export "graph 4 COVID-19 daily CFR, Iran, Johns Hopkins.pdf", replace
...
graph save "graph 5 COVID-19 daily CFR, Iran, Johns Hopkins, 01dec2020 on.gph", replace
// graph export "graph 5 COVID-19 daily CFR, Iran, Johns Hopkins, 01dec2020 on.pdf", replace
