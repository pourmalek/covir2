...
summ DayDeaMeRaA02S01 if date > td(01jan2021) 

gen DayDeaMeRaA02S01P4V = r(max)

summ date if DayDeaMeRaA02S01 == DayDeaMeRaA02S01P4V & date > td(01jan2021) 
...
summ DayDeaMeSmA02S02 if date > td(01jan2021) 

gen DayDeaMeSmA02S02P4V = r(max)

summ date if DayDeaMeSmA02S02 == DayDeaMeSmA02S02P4V & date > td(01jan2021) 
...
summ DayDeaMeSmA02S03 if date > td(01jan2021) 

gen DayDeaMeSmA02S03P4V = r(max)

label var DayDeaMeSmA02S03P4V "DayDeaMeSmA02S03P4V Peak 4 Value"

summ date if DayDeaMeSmA02S03 == DayDeaMeSmA02S03P4V
...
gen DayDeaMeSmA02S03PzV = r(max) 

label var DayDeaMeSmA02S03PzV "DayDeaMeSmA02S03 End date Value"

summ DayDeaLoSmA02S03 if date == A02DZ

gen DayDeaLoSmA02S03PzV = r(max) 

label var DayDeaLoSmA02S03PzV "DayDeaLoSmA02S03 End date Value"

summ DayDeaUpSmA02S03 if date == A02DZ

gen DayDeaUpSmA02S03PzV = r(max) 

label var DayDeaUpSmA02S03PzV "DayDeaUpSmA02S03 End date Value" 
...
summ DayCasMeRaA02S01 if date > td(01jan2021) 
...
summ DayCasMeRaA02S02 if date > td(01jan2021) 
...
line DayCasMeRaA02S03 date 

summ DayCasMeRaA02S03 if date > td(01jan2021) 

gen DayCasMeRaA02S03P4V = r(max)

summ date if DayCasMeRaA02S03 == DayCasMeRaA02S03P4V & date > td(01jan2021) 
...
gen DayCasMeRaA02S03PzV = r(max)

summ DayCasLoRaA02S03 if date == A02DZ

gen DayCasLoRaA02S03PzV = r(max)

summ DayCasUpRaA02S03 if date == A02DZ

gen DayCasUpRaA02S03PzV = r(max)

label var DayCasMeRaA02S03PzV "DayCasMeRaA02S03PzV End date Value"
label var DayCasLoRaA02S03PzV "DayCasLoRaA02S03PzV End date Value"
label var DayCasUpRaA02S03PzV "DayCasUpRaA02S03PzV End date Value"
