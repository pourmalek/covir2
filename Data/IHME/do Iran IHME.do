...
else if regexm(c(os),"Windows") == 1 import delimited using "$pathcovir2\IHME\2021_02_25\reference_hospitalization_all_locs.csv", clear varnames(1)
...
else if regexm(c(os),"Windows") == 1 import delimited using "$pathcovir2\IHME\2021_02_25\best_masks_hospitalization_all_locs.csv", clear varnames(1)
...
else if regexm(c(os),"Windows") == 1 import delimited using "$pathcovir2\IHME\2021_02_25\worse_hospitalization_all_locs.csv", clear varnames(1)
