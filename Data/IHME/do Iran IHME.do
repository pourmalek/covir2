...
rename seroprev_mean 		DaySerMeSmA02S01
rename seroprev_upper 		DaySerLoSmA02S01
rename seroprev_lower		DaySerUpSmA02S01

label var DaySerMeSmA02S01 "Daily seroprevalence Mean IHME S1"
label var DaySerLoSmA02S01 "Daily seroprevalence Lower IHME S1"
label var DaySerUpSmA02S01 "Daily seroprevalence Upper IHME S1"
...
rename seroprev_mean 		DaySerMeSmA02S02
rename seroprev_upper 		DaySerLoSmA02S02
rename seroprev_lower		DaySerUpSmA02S02

label var DaySerMeSmA02S02 "Daily seroprevalence Mean IHME S2"
label var DaySerLoSmA02S02 "Daily seroprevalence Lower IHME S2"
label var DaySerUpSmA02S02 "Daily seroprevalence Upper IHME S2"
...
rename seroprev_mean 		DaySerMeSmA02S03
rename seroprev_upper 		DaySerLoSmA02S03
rename seroprev_lower		DaySerUpSmA02S03

label var DaySerMeSmA02S03 "Daily seroprevalence Mean IHME S3"
label var DaySerLoSmA02S03 "Daily seroprevalence Lower IHME S3"
label var DaySerUpSmA02S03 "Daily seroprevalence Upper IHME S3"
...
twoway ///
(line DayCasMeRaA02S02 date, sort lcolor(black)) ///
(line DayCasLoRaA02S02 date, sort lcolor(green)) ///
(line DayCasUpRaA02S02 date, sort lcolor(red)) ///
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
twoway ///
(line DayCasMeRaA02S03 date, sort lcolor(black)) ///
(line DayCasLoRaA02S03 date, sort lcolor(green)) ///
(line DayCasUpRaA02S03 date, sort lcolor(red)) ///
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
* total cases, best scenario = S2, CI
...
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases) title("COVID-19 total cases, Iran, IHME, best scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "Mean" 2 "Lower" 3 "Upper") rows(1))

graph save "graph 19 COVID-19 total cases, Iran best scenario CI, IHME.gph", replace
// graph export "graph 19 COVID-19 total cases, Iran best scenario CI, IHME.pdf", replace



* total cases, worst scenario = S3, CI
...
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases) title("COVID-19 total cases, Iran, IHME, worst scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "Mean" 2 "Lower" 3 "Upper") rows(1))

graph save "graph 20 COVID-19 total cases, Iran worst scenario CI, IHME.gph", replace
// graph export "graph 20 COVID-19 total cases, Iran worst scenario CI, IHME.pdf", replace
...
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily tests) title("COVID-19 daily tests, Iran, IHME, median scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "S1" 2 "S2" 3 "S3") rows(1))

graph save "graph 29 COVID-19 daily tests, Iran 3 scenarios, IHME.gph", replace
// graph export "graph 29 COVID-19 daily tests, Iran 3 scenarios, IHME.pdf", replace
...
twoway ///
(line DaySerMeSmA02S01 date, sort lcolor(black)) ///
(line DaySerMeSmA02S02 date, sort lcolor(green)) ///
(line DaySerMeSmA02S03 date, sort lcolor(red)) ///
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily seroprevalence) title("COVID-19 daily seroprevalence, Iran, IHME, median scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "S1" 2 "S2" 3 "S3") rows(1))

graph save "graph 30 COVID-19 daily seroprevalence, Iran 3 scenarios, IHME.gph", replace
// graph export "graph 30 COVID-19 daily seroprevalence, Iran 3 scenarios, IHME.pdf", replace
...
(line DayVenMeSmA02S01 date, sort lcolor(red)) ///
(line DayAdmMeSmA02S01 date, sort lcolor(yellow)) ///
(line DayIcnMeSmA02S01 date, sort lcolor(blue)) ///
(line DayBeoMeSmA02S01 date, sort lcolor(black) lwidth(vthick) lpattern(tight_dot)) ///
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
graph save "graph 31 COVID-19 daily hospital-related outcomes 2, Iran median scenario, IHME.gph", replace
// graph export "graph 31 COVID-19 daily hospital-related outcomes 2, Iran median scenario, IHME.pdf", replace
...
summ DayDeaMeRaA02S01 if date > td(01mar2020) & date < td(30apr2020) 

gen DayDeaMeRaA02S01P1V = r(max)

summ date if DayDeaMeRaA02S01 == DayDeaMeRaA02S01P1V & date > td(01mar2020) & date < td(30apr2020)
...
tab1 DayDeaMeRaA02S01P1V DayDeaLoRaA02S01P1V DayDeaUpRaA02S01P1V DayDeaMeRaA02S01P1D
...
tab1 DayDeaMeRaA02S01P2V DayDeaLoRaA02S01P2V DayDeaLoRaA02S01P2V DayDeaMeRaA02S01P2D
...
tab1 DayDeaMeRaA02S01P3V DayDeaLoRaA02S01P3V DayDeaUpRaA02S01P3V DayDeaMeRaA02S01P3D


* fourth peak

summ DayDeaMeRaA02S01 if date > td(01mar2021) 

gen DayDeaMeRaA02S01P4V = r(max)

summ date if DayDeaMeRaA02S01 == DayDeaMeRaA02S01P4V & date > td(01mar2021) 
...
tab1 DayDeaMeRaA02S01P4V DayDeaLoRaA02S01P4V DayDeaUpRaA02S01P4V DayDeaMeRaA02S01P4D
...
gen DayDeaMeRaA02S01P8V = r(max)

summ DayDeaLoRaA02S01 if date == A02DZ

gen DayDeaLoRaA02S01P8V = r(max)

summ DayDeaUpRaA02S01 if date == A02DZ

gen DayDeaUpRaA02S01P8V = r(max)

label var DayDeaMeRaA02S01P8V "DayDeaMeRaA02S01P8V End Value"
label var DayDeaLoRaA02S01P8V "DayDeaLoRaA02S01P8V End Value"
label var DayDeaUpRaA02S01P8V "DayDeaUpRaA02S01P8V End Value"
format A02DZ %tdDDMonCCYY

tab1 DayDeaMeRaA02S01P8V DayDeaLoRaA02S01P8V DayDeaUpRaA02S01P8V A02DZ
...
summ DayDeaMeSmA02S02 if date > td(01mar2021) 

gen DayDeaMeSmA02S02P4V = r(max)

summ date if DayDeaMeSmA02S02 == DayDeaMeSmA02S02P4V & date > td(01mar2021) 
...
tab1 DayDeaMeSmA02S02P4V DayDeaLoSmA02S02P4V DayDeaUpSmA02S02P4V DayDeaMeSmA02S02P4D
...
gen DayDeaMeSmA02S02P8V = r(max)

summ DayDeaLoSmA02S02 if date == A02DZ

gen DayDeaLoSmA02S02P8V = r(max)

summ DayDeaUpSmA02S02 if date == A02DZ

gen DayDeaUpSmA02S02P8V = r(max)

label var DayDeaMeSmA02S02P8V "DayDeaMeSmA02S02P8V End Value"
label var DayDeaLoSmA02S02P8V "DayDeaLoSmA02S02P8V End Value"
label var DayDeaUpSmA02S02P8V "DayDeaUpSmA02S02P8V End Value"

tab1 DayDeaMeSmA02S02P8V DayDeaLoSmA02S02P8V DayDeaUpSmA02S02P8V A02DZ
...
summ DayDeaMeSmA02S03 if date > td(01mar2021) 

gen DayDeaMeSmA02S03P4V = r(max)

label var DayDeaMeSmA02S03P4V "DayDeaMeSmA02S03P4V Peak 4 Value"

summ date if DayDeaMeSmA02S03 == DayDeaMeSmA02S03P4V & date > td(01mar2021) 

gen DayDeaMeSmA02S03P4D = r(max)

label var DayDeaMeSmA02S03P4D "DayDeaMeSmA02S03P4V Peak 4 Date"

format DayDeaMeSmA02S03P4D %tdDDMonCCYY

summ DayDeaLoSmA02S03 if date == DayDeaMeSmA02S03P4D

gen DayDeaLoSmA02S03P4V = r(max)

label var DayDeaLoSmA02S03P4V "DayDeaLoSmA02S03 Peak 4 Value"

summ DayDeaUpSmA02S03 if date == DayDeaMeSmA02S03P4D

gen DayDeaUpSmA02S03P4V = r(max)

label var DayDeaUpSmA02S03P4V "DayDeaUpSmA02S03 Peak 4 Value"

tab1 DayDeaMeSmA02S03P4V DayDeaLoSmA02S03P4V DayDeaUpSmA02S03P4V DayDeaMeSmA02S03P4D



* end date avialable (P8)

summ DayDeaMeSmA02S03 if date == A02DZ

gen DayDeaMeSmA02S03P8V = r(max) 

label var DayDeaMeSmA02S03P8V "DayDeaMeSmA02S03 End Value"

summ DayDeaLoSmA02S03 if date == A02DZ

gen DayDeaLoSmA02S03P8V = r(max) 

label var DayDeaLoSmA02S03P8V "DayDeaLoSmA02S03 End Value"

summ DayDeaUpSmA02S03 if date == A02DZ

gen DayDeaUpSmA02S03P8V = r(max) 

label var DayDeaUpSmA02S03P8V "DayDeaUpSmA02S03 End Value" 

format A02DZ %tdDDMonCCYY

tab1 DayDeaMeSmA02S03P8V DayDeaLoSmA02S03P8V DayDeaUpSmA02S03P8V A02DZ
...
tab1 DayCasMeRaA02S01P1V DayCasLoRaA02S01P1V DayCasUpRaA02S01P1V DayCasMeRaA02S01P1D
...
tab1 DayCasMeRaA02S01P2V DayCasLoRaA02S01P2V DayCasUpRaA02S01P2V DayCasMeRaA02S01P2D
...
tab1 DayCasMeRaA02S01P3V DayCasLoRaA02S01P3V DayCasUpRaA02S01P3V DayCasMeRaA02S01P3D


* fourth peak

summ DayCasMeRaA02S01 if date > td(01mar2021) 

gen DayCasMeRaA02S01P4V = r(max)

summ date if DayCasMeRaA02S01 == DayCasMeRaA02S01P4V & date > td(01jan2021) 
...
tab1 DayCasMeRaA02S01P4V DayCasLoRaA02S01P4V DayCasUpRaA02S01P4V DayCasMeRaA02S01P4D
...
gen DayCasMeRaA02S01P8V = r(max)

summ DayCasLoRaA02S01 if date == A02DZ

gen DayCasLoRaA02S01P8V = r(max)

summ DayCasUpRaA02S01 if date == A02DZ

gen DayCasUpRaA02S01P8V = r(max)

label var A02DZ "A02 End date"
label var DayCasMeRaA02S01P8V "DayCasMeRaA02S01 End Value"
label var DayCasLoRaA02S01P8V "DayCasLoRaA02S01 End Value"
label var DayCasUpRaA02S01P8V "DayCasUpRaA02S01 End Value"
format A02DZ %tdDDMonCCYY

tab1 DayCasMeRaA02S01P8V DayCasLoRaA02S01P8V DayCasUpRaA02S01P8V A02DZ
...
summ DayCasMeRaA02S02 if date > td(01mar2021) 

gen DayCasMeRaA02S02P4V = r(max)

summ date if DayCasMeRaA02S02 == DayCasMeRaA02S02P4V & date > td(01jan2021) 
...
tab1 DayCasMeRaA02S02P4V DayCasLoRaA02S02P4V DayCasUpRaA02S02P4V DayCasMeRaA02S02P4D
...
gen DayCasMeRaA02S02P8V = r(max)

summ DayCasLoRaA02S02 if date == A02DZ

gen DayCasLoRaA02S02P8V = r(max)

summ DayCasUpRaA02S02 if date == A02DZ

gen DayCasUpRaA02S02P8V = r(max)

label var DayCasMeRaA02S02P8V "DayCasMeRaA02S02 End Value"
label var DayCasLoRaA02S02P8V "DayCasLoRaA02S02 End Value"
label var DayCasUpRaA02S02P8V "DayCasUpRaA02S02 End Value"
...
summ DayCasMeRaA02S03 if date > td(01mar2021) 

gen DayCasMeRaA02S03P4V = r(max)

summ date if DayCasMeRaA02S03 == DayCasMeRaA02S03P4V & date > td(01mar2021) 

gen DayCasMeRaA02S03P4D = r(max)

summ DayCasLoRaA02S03 if date == DayCasMeRaA02S03P4D

gen DayCasLoRaA02S03P4V = r(max)

summ DayCasUpRaA02S03 if date == DayCasMeRaA02S03P4D

gen DayCasUpRaA02S03P4V = r(max)

label var DayCasMeRaA02S03P4V "DayCasMeRaA02S01P4V Peak 4 Value"
label var DayCasMeRaA02S03P4D "DayCasMeRaA02S01P4D Peak 4 Date"
label var DayCasLoRaA02S03P4V "DayCasLoRaA02S01P4V Peak 4 Value"
label var DayCasUpRaA02S03P4V "DayCasUpRaA02S01P4V Peak 4 Value"
format DayCasMeRaA02S03P4D %tdDDMonCCYY

tab1 DayCasMeRaA02S03P4V DayCasLoRaA02S03P4V DayCasUpRaA02S03P4V DayCasMeRaA02S03P4D


* end date avialable (P8)

summ DayCasMeRaA02S03 if date == A02DZ

gen DayCasMeRaA02S03P8V = r(max)

summ DayCasLoRaA02S03 if date == A02DZ

gen DayCasLoRaA02S03P8V = r(max)

summ DayCasUpRaA02S03 if date == A02DZ

gen DayCasUpRaA02S03P8V = r(max)

label var DayCasMeRaA02S03P8V "DayCasMeRaA02S03 End Value"
label var DayCasLoRaA02S03P8V "DayCasLoRaA02S03 End Value"
label var DayCasUpRaA02S03P8V "DayCasUpRaA02S03 End Value"
format A02DZ %tdDDMonCCYY

tab1 DayCasMeRaA02S03P8V DayCasLoRaA02S03P8V DayCasUpRaA02S03P8V A02DZ
