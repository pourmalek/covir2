...
rename outcome DayCasMeRaA07S09V00

label var DayCasMeRaA07S09V00 "Daily Cases GHAN S9" 
...
drop if DayCasMeRaA07S09V00 == . & date > td(12Dec2021)

order date DayCasMeRaA07S09V00
...
twoway /// 
(line DayCasMeRaA07S09V00 date, sort lcolor(blue)) ///
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily Acive cases) title("COVID-19 daily cases, Iran, GHAN, median scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) ///
note("(Daily cases in population with ‘a strong immunity system’)")
...
gen DayCasMeRaA07S09V00P2V = 897264

label var DayCasMeRaA07S09V00P2V "DayCasMeRaA07S09V00 Peak 2 Value"

gen DayCasMeRaA07S09V00P2D = td(18feb2021)

label var DayCasMeRaA07S09V00P2D "DayCasMeRaA07S09V00 Peak 2 Date"
