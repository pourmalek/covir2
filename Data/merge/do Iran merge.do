...
* Day CTD all studies, all time, reference scenarios
...
* Day CTD all studies, 01apr2020 on, reference scenarios
...
* Day CTD all studies, 01apr2020 on, 3 scenarios
...
* Total CTD all studies, all time, reference scenarios
...
* Total CTD all studies, 01apr2020 on, reference scenarios
...
A05 LANL Los Alamos National Laboratory
A05 SRIV Srivastava
...
keep if regexm(varname,"A02") == 1 | regexm(varname,"A03") == 1 | regexm(varname,"A05") == 1 | regexm(varname,"A05") == 1 
