...
(line DayDeaMeRaA05S00V02 date, sort lcolor(gold)) /// 5 "LANL"
...
(line DayDeaMeRaA05S00V02 date, sort lcolor(gold)) /// 7 "LANL"
...
(line DayDeaMeRaA05S00V02 date, sort lcolor(gold)) /// 11 LANL mean
(line DayDeaLoRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL lower
(line DayDeaUpRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL upper
...
(line DayDeaMeRaA05S00V02 date, sort lcolor(gold)) /// 13 LANL mean
(line DayDeaLoRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL lower
(line DayDeaUpRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 15 LANL upper
...
* daily deaths, median or reference scenario, 30nov2020 on, CI, wo DELP upper and IMPE upper  
...
(line DayDeaMeRaA05S00V02 date, sort lcolor(gold)) /// 9 LANL mean
(line DayDeaLoRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 10 LANL lower
(line DayDeaUpRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 11 LANL upper
...
graph save "graph 14a COVID-19 daily deaths, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper.gph", replace
graph export "graph 14a COVID-19 daily deaths, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper.pdf", replace
...
graph save "graph 14b COVID-19 daily deaths, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper, w CF.gph", replace
graph export "graph 14b COVID-19 daily deaths, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper, w CF.pdf", replace
...
(line DayCasMeRaA05S00V02 date, sort lcolor(gold)) /// 7 "LANL"
...
(line DayCasMeRaA05S00V02 date, sort lcolor(gold)) /// 5 "LANL"
...
(line DayCasMeRaA05S00V02 date, sort lcolor(gold)) /// 11 LANL mean
(line DayCasLoRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL lower
(line DayCasUpRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL upper
...
(line DayCasMeRaA05S00V02 date, sort lcolor(gold)) /// 13 LANL mean
(line DayCasLoRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL lower
(line DayCasUpRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 15 LANL upper
...
* daily cases, median or reference scenario, 30nov2020 on, CI, wo IMPE upper
...
(line DayCasMeRaA03S02V07 date, sort lcolor(magenta)) /// 8 IMPE mean
(line DayCasLoRaA03S02V07 date, sort lcolor(magenta) lpattern(dash)) /// 9 IMPE lower
(line DayCasMeRaA05S00V02 date, sort lcolor(gold)) /// 10 LANL mean
(line DayCasLoRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 11 LANL lower
(line DayCasUpRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL upper
...
graph save "graph 24a COVID-19 daily cases, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper.gph", replace
graph export "graph 24a COVID-19 daily cases, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper.pdf", replace
...
* daily cases, median or reference scenario, 30nov2020 on, CI, wo IMPE upper, w CF
...
(line DayCasMeRaA03S02V07 date, sort lcolor(magenta)) /// 10 IMPE mean
(line DayCasLoRaA03S02V07 date, sort lcolor(magenta) lpattern(dash)) /// 11 IMPE lower
(line DayCasMeRaA05S00V02 date, sort lcolor(gold)) /// 12 LANL mean
(line DayCasLoRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL lower
(line DayCasUpRaA05S00V02 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL upper
...
graph save "graph 24b COVID-19 daily cases, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper., w CF.gph", replace
graph export "graph 24b COVID-19 daily cases, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper, w CF.pdf", replace
...
(line TotDeaMeRaA05S00V0 date, sort lcolor(gold)) /// 5 "LANL"
...
(line TotDeaMeRaA05S00V0 date, sort lcolor(gold)) /// 7 "LANL"
...
(line TotDeaMeRaA05S00V0 date, sort lcolor(gold)) /// 11 LANL mean
(line TotDeaLoRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL lower
(line TotDeaUpRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL upper
...
(line TotDeaMeRaA05S00V0 date, sort lcolor(gold)) /// 13 LANL mean
(line TotDeaLoRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL lower
(line TotDeaUpRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 15 LANL upper
...
* total deaths, median or reference scenario, 30nov2020 on, CI, wo IMPE upper
...
(line TotDeaMeRaA03S02V07 date, sort lcolor(magenta)) /// 8 IMPE mean
(line TotDeaLoRaA03S02V07 date, sort lcolor(magenta) lpattern(dash)) /// 9 IMPE lower
(line TotDeaMeRaA05S00V0 date, sort lcolor(gold)) /// 10 LANL mean
(line TotDeaLoRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 11 LANL lower
(line TotDeaUpRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL upper
...
graph save "graph 35a COVID-19 total deaths, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper.gph", replace
graph export "graph 35a COVID-19 total deaths, Iran, reference scenarios, 30nov2020 on, CI, wo IMPE upper.pdf", replace
...
(line TotCasMeRaA05S00V0 date, sort lcolor(gold)) /// 5 "LANL"
...
(line TotCasMeRaA05S00V0 date, sort lcolor(gold)) /// 7 "LANL"
...
(line TotCasMeRaA05S00V0 date, sort lcolor(gold)) /// 11 LANL mean
(line TotCasLoRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL lower
(line TotCasUpRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL upper
...
(line TotCasMeRaA05S00V0 date, sort lcolor(gold)) /// 13 LANL mean
(line TotCasLoRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL lower
(line TotCasUpRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 15 LANL upper
...
(line TotCasMeRaA03S02V07 date, sort lcolor(magenta)) /// 8 IMPE mean
(line TotCasLoRaA03S02V07 date, sort lcolor(magenta) lpattern(dash)) /// 9 IMPE lower
(line TotCasMeRaA05S00V0 date, sort lcolor(gold)) /// 10 LANL mean
(line TotCasLoRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 11 LANL lower
(line TotCasUpRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL upper
...
(line TotCasMeRaA03S02V07 date, sort lcolor(magenta)) /// 10 IMPE mean
(line TotCasLoRaA03S02V07 date, sort lcolor(magenta) lpattern(dash)) /// 11 IMPE lower
(line TotCasMeRaA05S00V0 date, sort lcolor(gold)) /// 12 LANL mean
(line TotCasLoRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 13 LANL lower
(line TotCasUpRaA05S00V0 date, sort lcolor(gold) lpattern(dash)) /// 14 LANL upper
...
(line DayCfrMeRaA05S00V0 date, sort lcolor(gold)) /// 5 "LANL"
...
subtitle("after 2020-03-01, without JOHN, LANL, SRIV, with uncertainty", size(small))
...
(line DayDERMeRaA01S00V03 date, sort lcolor(red)) /// 1 "DELP"
...
if date > td(31dec2019) & date < td(02may2021) ///
...
twoway ///
(line DayDERMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN"
(line DayDERMeRaA01S00V03 date, sort lcolor(red)) /// 2 "DELP"
(line DayDERMeRaA02S01V03 date, sort lcolor(black)) /// 3 "IHME"
(line DayDERMeRaA03S02V07 date, sort lcolor(magenta)) /// 4 "IMPE"
(line DayDERMeRaA04S00V02 date, sort lcolor(gold)) /// 5 "LANL"
(line DayDERMeRaA05S00V02 date, sort lcolor(green)) /// 6 "SRIV"
if date > td(28feb2021) & date < td(11apr2021) ///
, xtitle(Date) xlabel(22340(10)22380, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(0(0.25)1.75, format(%12.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths estimated to reprted) title("COVID-19 daily deaths estimated to reprted, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN" 2 "DELP" 3 "IHME" 4 "IMPE" 5 "LANL" 6 "SRIV") size(small) row(1)) ///
subtitle("after 2021-03-01 to 2021-04-10", size(small))
...
* daily cases estimated to reprted (DER) all studies, all time, reference scenarios


twoway ///
(line DayCERMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN"
(line DayCERMeRaA01S00V03 date, sort lcolor(red)) /// 2 "DELP"
(line DayCERMeRaA02S01V03 date, sort lcolor(black)) /// 3 "IHME"
(line DayCERMeRaA03S02V07 date, sort lcolor(magenta)) /// 4 "IMPE"
(line DayCERMeRaA04S00V02 date, sort lcolor(gold)) /// 5 "LANL"
(line DayCERMeRaA05S00V02 date, sort lcolor(green)) /// 6 "SRIV"
if date > td(31dec2019) & date < td(02may2021) ///
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
* daily cases estimated to reprted (DER) all studies, 01mar2021 on, reference scenarios
...
(line TotDERMeRaA01S00V03 date, sort lcolor(red)) /// 1 "DELP"
...
twoway ///
(line TotDERMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN"
(line TotDERMeRaA01S00V03 date, sort lcolor(red)) /// 2 "DELP"
(line TotDERMeRaA02S01V03 date, sort lcolor(black)) /// 3 "IHME"
(line TotDERMeRaA03S02V07 date, sort lcolor(magenta)) /// 4 "IMPE"
(line TotDERMeRaA04S00V02 date, sort lcolor(gold)) /// 5 "LANL"
(line TotDERMeRaA05S00V02 date, sort lcolor(green)) /// 6 "SRIV"
if date > td(01mar2021) & date < td(11apr2021) ///
, xtitle(Date) xlabel(22340(10)22380, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths estimated to reprted) title("COVID-19 total deaths estimated to reprted, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
* total cases estimated to reprted (DER) all studies, all time, reference scenarios


twoway ///
(line TotCERMeRaA00S00V00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 "JOHN"
(line TotCERMeRaA01S00V03 date, sort lcolor(red)) /// 2 "DELP"
(line TotCERMeRaA02S01V03 date, sort lcolor(black)) /// 3 "IHME"
(line TotCERMeRaA03S02V07 date, sort lcolor(magenta)) /// 4 "IMPE"
(line TotCERMeRaA04S00V02 date, sort lcolor(gold)) /// 5 "LANL"
(line TotCERMeRaA05S00V02 date, sort lcolor(green)) /// 6 "SRIV"
if date > td(31dec2019) & date < td(02may2021) ///
, xtitle(Date) xlabel(#17, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
* total cases estimated to reprted (DER) all studies, 01mar2021 on, reference scenarios
