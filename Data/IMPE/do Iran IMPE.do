...
graph save "graph 3 COVID-19 total cases, 6 scenarios, Iran, IMPE.gph", replace
graph export "graph 3 COVID-19 total cases, 6 scenarios, Iran, IMPE.pdf", replace
...
graph save "graph 4 COVID-19 total cases, median scenario, Iran, IMPE.gph", replace
graph export "graph 4 COVID-19 total cases, median scenario, Iran, IMPE.pdf", replace
...
summ DayDeaMeRaA03S02V07 if date > td(01mar2021) 

gen DayDeaMeRaA03S02V07P4V = r(max)

summ date if DayDeaMeRaA03S02V07 == DayDeaMeRaA03S02V07P4V & date > td(01mar2021) 
...
summ DayDeaMeRaA03S01V07 if date > td(01mar2021) 

gen DayDeaMeRaA03S01V07P4V = r(max)

summ date if DayDeaMeRaA03S01V07 == DayDeaMeRaA03S01V07P4V & date > td(01mar2021)
...
summ DayDeaMeRaA03S03V07 if date > td(01mar2021) 

gen DayDeaMeRaA03S03V07P4V = r(max) 

summ date if DayDeaMeRaA03S03V07 == DayDeaMeRaA03S03V07P4V & date > td(01mar2021) 
...
summ DayCasMeRaA03S02V07 if date > td(01mar2021) 

gen DayCasMeRaA03S02V07P4V = r(max)

summ date if DayCasMeRaA03S02V07 == DayCasMeRaA03S02V07P4V & date > td(01mar2021) 
...
summ DayCasMeRaA03S01V07 if date > td(01mar2021) 

gen DayCasMeRaA03S01V07P4V = r(max)

summ date if DayCasMeRaA03S01V07 == DayCasMeRaA03S01V07P4V & date > td(01mar2021) 
...
summ DayCasMeRaA03S03V07 if date > td(01mar2021) 

gen DayCasMeRaA03S03V07P4V = r(max)

summ date if DayCasMeRaA03S03V07 == DayCasMeRaA03S03V07P4V & date > td(01mar2021) 
