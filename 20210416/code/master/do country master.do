...
* This is "do country master.do"
                                                                                                          ***************************
* Project: CovidVisualized country - countries without subnational estimates                              * this is uptake 20210416 *
...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20210416 (old), with 20210416 (new) <<--           <<<--- * change uptake date here *
                                                                                                         ***************************
...
covir2-main/20210416/output/merge/*.pdf
