...
* This is "do country master.do"
                                                                                                          ***************************
* Project: CovidVisualized country - countries without subnational estimates                              * this is uptake 20211217 *
...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20211217 (old), with 20211217 (new) <<--           <<<--- * change uptake date here *
                                                                                                         ***************************
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20211217/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20211217\code"
}
*
