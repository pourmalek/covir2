...
*****************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 2021-12-17 (old), with 2021-12-17 (new) <<--       <<<--- * change update date here *
                                                                                                         ***************************

																										 																										 
******* Also, find and replace ALL, 16dec2021 (old), with 16dec2021 (new) **********              <<<---       *  AND HERE  *
                                                                                                         ***************************
...
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-12-17/global_forecasts_deaths.csv global_forecasts_deaths.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-12-17/global_forecasts_deaths_lb.csv global_forecasts_deaths_lb.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-12-17/global_forecasts_deaths_ub.csv global_forecasts_deaths_ub.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-12-17/global_forecasts_cases.csv global_forecasts_cases.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-12-17/global_forecasts_cases_lb.csv global_forecasts_cases_lb.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-12-17/global_forecasts_cases_ub.csv global_forecasts_cases_ub.csv
...
gen date = .
replace date = td(16dec2021) in 1
