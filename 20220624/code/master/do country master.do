...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20220624 (old), with 20220624 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************
...
global SRIVepoch 23Jun2022 // update release date																		 
*            9/ ----------
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220624/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220624\code"
}
*
...
// do "$pathcovir2/IMPE/do country IMPE.do" // The IMPE update 20220530 was released on 20220624. Not included. 
