...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20220218 (old), with 20220218 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************

* To change uptake date in individual do files for models, change the following dates:

global DELPdate 20220218 
*            2/ --------

global IMPEdate 2022-01-02_v9 // IMPE 2022-01-02_v9.csv.zip is > one month old
*            3/ -------------

global SRIVdate 2022-02-18 
*            4/ ----------

global IHMEdate 20220218																		 
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220218/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220218\code"
}
*
...
// do "$pathcovir2/IMPE/do country IMPE.do" // IMPE 2022-01-02_v9.csv.zip is > one month old
