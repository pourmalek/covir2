...
*****************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 2021-08-26 (old), with 2021-08-26 (new) <<--       <<<--- * change update date here *
                                                                                                         ***************************

																										 																										 
******* Also, find and replace ALL, 25aug2021 (old), with 25aug2021 (new) **********              <<<---       *  AND HERE  *
                                                                                                         ***************************
...
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-08-26/global_forecasts_deaths.csv global_forecasts_deaths.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-08-26/global_forecasts_deaths_lb.csv global_forecasts_deaths_lb.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-08-26/global_forecasts_deaths_ub.csv global_forecasts_deaths_ub.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-08-26/global_forecasts_cases.csv global_forecasts_cases.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-08-26/global_forecasts_cases_lb.csv global_forecasts_cases_lb.csv
copy https://raw.githubusercontent.com/scc-usc/ReCOVER-COVID-19/master/results/historical_forecasts/2021-08-26/global_forecasts_cases_ub.csv global_forecasts_cases_ub.csv
...
gen date = .
replace date = td(25aug2021) in 1
