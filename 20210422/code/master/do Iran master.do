...
* This is "do Iran master.do"
                                                                                                          *******************
* Project: COVID-19 Iran Review No 2                                                                      * uptake 20210422 *
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20210422/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20210422\code"
}
*
