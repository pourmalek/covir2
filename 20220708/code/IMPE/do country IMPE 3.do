...
legend(order(13 "JOHN" 1 "IMPE previous updates, backcast" 7 "IMPE previous updates, forecast" ///
12 "IMPE latest update 20220620, forecast") size(small) row(2)) ///
...
6 "IMPE latest update 20220620, forecast") size(small) row(2)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, $country, IMPE, updates in 2022", size(medium) color(black)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(11 "JOHN" 1 "IMPE previous updates, backcast" 6 "IMPE previous updates, forecast" ///
10 "IMPE latest update 20220620, forecast") size(small) row(2)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, $country, IMPE, updates in 2022", size(medium) color(black)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(6 "JOHN" 1 "IMPE previous updates, forecast" ///
5 "IMPE latest update 20220620, forecast") size(small) row(2)) ///
