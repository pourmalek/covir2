...
(line DayDeaMeRaA04S00V02 date, sort lcolor(gold)) /// 5 "LANL"
(line DayDeaMeRaA05S00V02 date, sort lcolor(green)) /// 6 "SRIV"
if date > td(20dec2020) & date < td(30jul2021) ///
, xtitle(Date) xlabel(22270 22300 22330 22360 22391 22422 22453 22484, ///
format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, Iran, reference scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
0 19feb2021  "Esf" 0 21mar2021  "Far" 0 21apr2021  "Ord" 0 22may2021  "Kho" ///
0 22jun2021  "Tir" 0 23jul2021  "Mor" , size(small) color(black))
...
* daily cases estimated to reported (CER) all studies, 01mar2021 on, reference scenarios
...
graph save "graph 93 COVID-19 daily cases estimated to reported, Iran, reference scenarios, 01mar2021 on.gph", replace
graph export "graph 93 COVID-19 daily cases estimated to reported, Iran, reference scenarios, 01mar2021 on.pdf", replace
...
* total deaths estimated to reported (DER) all studies, 01mar2021 on, reference scenarios
...
graph save "graph 96 COVID-19 total deaths estimated to reported, Iran, reference scenarios, 01mar2021 on.gph", replace
graph export "graph 96 COVID-19 total deaths estimated to reported, Iran, reference scenarios, 01mar2021 on.pdf", replace
...
* total cases estimated to reported (CER) all studies, 01mar2021 on, reference scenarios
...
graph save "graph 98 COVID-19 total cases estimated to reported, Iran, reference scenarios, 01mar2021 on.gph", replace
graph export "graph 98 COVID-19 total cases estimated to reported, Iran, reference scenarios, 01mar2021 on.pdf", replace
