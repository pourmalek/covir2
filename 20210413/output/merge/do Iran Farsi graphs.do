...
, xtitle(تاریخ) ///
xlabel(21 51 80 111 142 173 204 235 266 296 326 356 386 416 446 477 508 539 570) ///
ytitle(مرگ های روزانه) ///
xlabel(, nolabels) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five) nogrid) ///
...
, xtitle(تاریخ) ///
xlabel(80 111 142 173 204 235 266 296 326 356 386 416 446 477 508 539 570 601 632 662) ///
...
(line DayDERMeRaA03S02V07 day1is01jan2020, sort lcolor(magenta)) /// 3 "IMPE"
(line DayDERMeRaA04S00V02 day1is01jan2020, sort lcolor(gold)) /// 4 "LANL"
(line DayDERMeRaA05S00V02 day1is01jan2020, sort lcolor(green)) /// 5 "SRIV"
if date >= td(19feb2021) & date <= td(21apr2021) ///
, xtitle(تاریخ) ///
xlabel(416 430 446 460 477) ///
xlabel(, nolabels) ylabel(0(0.25)2, format(%12.2fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
