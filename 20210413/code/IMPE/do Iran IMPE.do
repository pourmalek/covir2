...
copy https://raw.githubusercontent.com/mrc-ide/global-lmic-reports/master/IRN/2021-03-29/projections.csv projections.csv
...
* IMPE daily deaths after third peak:
(graph 1 COVID-19 daily deaths, 6 scenarios, Iran, IMPE)

One small peak in 21-02-01 to 21-04-01 for all scenarios  date > td(01feb2021) &  date < td(01apr2021)
 

After that small peak,   
no 4th peak, S2 (median) increases slightly until end date  date == td(16jun2021)
no 4th peak, S1 (best) decreases drastically until end date  date == td(16jun2021)
yes 4th peak, S3 (works) shoots up to a forth peak early after 21-06-01  date >  td(01apr2021)




* IMPE daily cases after third peak:
(graph 5 COVID-19 daily cases, 6 scenarios, Iran, IMPE)

One small peak in 21-02-01 to 21-03-01	date > td(01feb2021) &  date < td(01mar2021)

After that small peak,   
no 4th peak, S2 (median) increases slightly until end date	date == td(16jun2021)
no 4th peak, S1 (best) decreases drastically until end date	 date == td(16jun2021)
yes 4th peak, S3 (works) shoots up to a forth peak before 21-06-01	date >  td(01apr2021)

						
          summ: S1 and S2 do not show a large fourth peak during the time shown (ending 16jun2021), but S3 does.
...
summ DayDeaMeRaA03S03V07 if date >  td(01apr2021)

gen DayDeaMeRaA03S03V07P5V = r(max) 

summ date if DayDeaMeRaA03S03V07 == DayDeaMeRaA03S03V07P5V & date >  td(01apr2021)

gen DayDeaMeRaA03S03V07P5D = r(max) 

summ DayDeaLoRaA03S03V07 if date == DayDeaMeRaA03S03V07P5D

gen DayDeaLoRaA03S03V07P5V = r(max)

summ DayDeaUpRaA03S03V07 if date == DayDeaMeRaA03S03V07P5D

gen DayDeaUpRaA03S03V07P5V = r(max)

label var DayDeaMeRaA03S03V07P5V "DayDeaMeRaA03S03V07 Peak 4 Value"
label var DayDeaMeRaA03S03V07P5D "DayDeaMeRaA03S03V07 Peak 4 Date"
label var DayDeaLoRaA03S03V07P5V "DayDeaLoRaA03S03V07 Peak 4 Value"
label var DayDeaUpRaA03S03V07P5V "DayDeaUpRaA03S03V07 Peak 4 Value"
format DayDeaMeRaA03S03V07P5D %tdDDMonCCYY

tab1 DayDeaMeRaA03S03V07P5V DayDeaLoRaA03S03V07P5V DayDeaUpRaA03S03V07P5V DayDeaMeRaA03S03V07P5D
...
summ DayCasMeRaA03S03V07 if date >  td(01apr2021)

gen DayCasMeRaA03S03V07P4V = r(max)

summ date if DayCasMeRaA03S03V07 == DayCasMeRaA03S03V07P4V & date >  td(01apr2021)
