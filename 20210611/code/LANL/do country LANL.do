...
*****************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 2021-06-06 (old), with 2021-06-06 (new) <<--       <<<--- * change update date here *
                                                                                                         ***************************
...
copy https://covid-19.bsvgateway.org/forecast/global/2021-06-06/files/2021-06-06_global_cumulative_daily_cases_website.csv 2021-06-06_global_cumulative_daily_cases_website.csv

copy https://covid-19.bsvgateway.org/forecast/global/2021-06-06/files/2021-06-06_global_cumulative_daily_deaths_website.csv 2021-06-06_global_cumulative_daily_deaths_website.csv

copy https://covid-19.bsvgateway.org/forecast/global/2021-06-06/files/2021-06-06_global_incidence_daily_cases_website.csv 2021-06-06_global_incidence_daily_cases_website.csv

copy https://covid-19.bsvgateway.org/forecast/global/2021-06-06/files/2021-06-06_global_incidence_daily_deaths_website.csv 2021-06-06_global_incidence_daily_deaths_website.csv 
...
* Total Cases
import delimited using "2021-06-06_global_cumulative_daily_cases_website.csv", clear varnames(1)
save "global_cumulative_daily_cases.dta", replace

* Total Deaths
import delimited using "2021-06-06_global_cumulative_daily_deaths_website.csv", clear varnames(1)
save "global_cumulative_daily_deaths.dta", replace

* Daily Cases
import delimited using "2021-06-06_global_incidence_daily_cases_website.csv", clear varnames(1)
save "global_incidence_daily_cases.dta", replace

* Daily Deaths 
import delimited using "2021-06-06_global_incidence_daily_deaths_website.csv", clear varnames(1)
