...
* This is "do Iran master.do"
                                                                                                          *******************
* Project: COVID-19 Iran Review No 2                                                                      * uptake 20210507 *
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20210507/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20210507\code"
}
*
...
data in covir2-main/20210507/output/merge/country.dta
and graphs stored in:
covir2-main /covir2/20210507/output/merge/*.pdf
and covir2-main /20210507/output/IMPE/*.pdf
