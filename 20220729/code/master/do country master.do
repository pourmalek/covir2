...
global IMPEepoch 03Jun2022 // update release date																		 
*            8/ ----------

global SRIVepoch 29Jul2022 // update release date																		 
*            9/ ----------
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220729/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220729\code"
}
*
...
// do "$pathcovir2/IMPE/do country IMPE.do" // Latest models' updates > 2 weeks are not included.
