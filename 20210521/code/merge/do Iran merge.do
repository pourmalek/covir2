...
* daily cases, median or reference scenario, 2020-12-01 on, CI, wo DLEP upper

twoway ///
(line DayCasMeRaA00S00 date, sort lcolor(cyan) lwidth(vthick) lpattern(tight_dot)) /// 1 JOHN
(line DayCasMeRaA01S00 date, sort lcolor(red)) /// 2 "DELP" mean
(line DayCasLoRaA01S00 date, sort lcolor(red) lpattern(dash)) /// 3 "DELP" lower
(line DayCasMeRaA02S01 date, sort lcolor(black)) /// 4 IHME mean
(line DayCasLoRaA02S01 date, sort lcolor(black) lpattern(dash)) /// 5 IHME lower
(line DayCasUpRaA02S01 date, sort lcolor(black) lpattern(dash)) /// 6 IHME upper
(line DayCasMeRaA03S02 date, sort lcolor(magenta)) /// 7 IMPE mean
(line DayCasLoRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 8 IMPE lower
(line DayCasUpRaA03S02 date, sort lcolor(magenta) lpattern(dash)) /// 9 IMPE upper
(line DayCasMeRaA04S00 date, sort lcolor(gold)) /// 10 LANL mean
(line DayCasLoRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 11 LANL lower
(line DayCasUpRaA04S00 date, sort lcolor(gold) lpattern(dash)) /// 12 LANL upper
(line DayCasMeRaA05S00 date, sort lcolor(green)) /// 13 "SRIV" mean
...
graph save "graph 27 COVID-19 daily cases, Iran, reference scenarios, 2020-12-01 on, CI, wo DLEP upper.gph", replace
graph export "graph 27 COVID-19 daily cases, Iran, reference scenarios, 2020-12-01 on, CI, wo DLEP upper.pdf", replace
...
graph save "graph 28 COVID-19 daily cases, Iran, full scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 28 COVID-19 daily cases, Iran, full scenarios, 2020-12-01 on, CI.pdf", replace
