...
***************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 2021-12-13 (old), with 2021-12-13 (new) <<--       <<<--- * change update date here *
                                                                                                         ***************************
...
save "CovidVisualizedCountry IMPE.dta", replace
...
ytitle(Daily deaths) title("COVID-19 daily deaths, $country, IMPE, 6 scenarios", size(medium)) ///
...
qui graph save "1DayDeaIMPE 6 scenarios - COVID-19 daily deaths, 6 scenarios, $country, IMPE.gph", replace
qui graph export "1DayDeaIMPE 6 scenarios - COVID-19 daily deaths, 6 scenarios, $country, IMPE.pdf", replace




* daily deaths, S2 = reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily deaths) title("COVID-19 daily deaths, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "2DayDeaIMPE reference scenario - COVID-19 daily deaths, reference scenario, $country, IMPE.gph", replace
qui graph export "2DayDeaIMPE reference scenario - COVID-19 daily deaths, reference scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths) title("COVID-19 total deaths, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "3TotDeaIMPE 6 scenarios - COVID-19 total deaths, 6 scenarios, $country, IMPE.gph", replace
qui graph export "3TotDeaIMPE 6 scenarios - COVID-19 total deaths, 6 scenarios, $country, IMPE.pdf", replace




* total deaths, S2 = reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Total deaths) title("COVID-19 total deaths, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "4TotDeaIMPE reference scenario - COVID-19 total deaths, reference scenario, $country, IMPE.gph", replace
qui graph export "4TotDeaIMPE reference scenario - COVID-19 total deaths, reference scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily infections) title("COVID-19 daily infections, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "5DayINFIMPE 6 scenarios - COVID-19 daily infections, 6 scenarios, $country, IMPE.gph", replace
qui graph export "5DayINFIMPE 6 scenarios - COVID-19 daily infections, 6 scenarios, $country, IMPE.pdf", replace




* daily infections, S2 = reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily infections) title("COVID-19 daily infections, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "6DayINFIMPE reference scenario - COVID-19 daily infections, reference scenario, $country, IMPE.gph", replace
qui graph export "6DayINFIMPE reference scenario - COVID-19 daily infections, reference scenario, $country, IMPE.pdf", replace
...
ytitle(Total infections) title("COVID-19 total infections, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "7TotINFIMPE 6 scenarios - COVID-19 total infections, 6 scenarios, $country, IMPE.gph", replace
qui graph export "7TotINFIMPE 6 scenarios - COVID-19 total infections, 6 scenarios, $country, IMPE.pdf", replace




* total infections, S2 = reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Total infections) title("COVID-19 total infections, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "8TotINFIMPE reference scenario - COVID-19 total infections, reference scenario, $country, IMPE.gph", replace
qui graph export "8TotINFIMPE reference scenario - COVID-19 total infections, reference scenario, $country, IMPE.pdf", replace
...
ytitle(Daily IFR) title("COVID-19 daily IFR, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "9DayIFRIMPE 6 scenarios - COVID-19 daily IFR, 6 scenarios, $country, IMPE.gph", replace
qui graph export "9DayIFRIMPE 6 scenarios - COVID-19 daily IFR, 6 scenarios, $country, IMPE.pdf", replace




* daily IFR, S2 = reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%9.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily IFR) title("COVID-19 daily IFR, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "10DayIFRIMPE reference scenario - COVID-19 daily IFR, reference scenario, $country, IMPE.gph", replace
qui graph export "10DayIFRIMPE reference scenario - COVID-19 daily IFR, reference scenario, $country, IMPE.pdf", replace
...
* daily hospital demand, reference scenario
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily outcome) title("COVID-19 daily hospital demand, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "11DayHodIMPE reference scenario - COVID-19 daily hospital demand, reference scenario, $country, IMPE.gph", replace
qui graph export "11DayHodIMPE reference scenario - COVID-19 daily hospital demand, reference scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcome) title("COVID-19 daily hospital demand, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "12DayHodIMPE 6 scenarios - COVID-19 daily hospital demand, 6 scenarios, $country, IMPE.gph", replace
qui graph export "12DayHodIMPE 6 scenarios - COVID-19 daily hospital demand, 6 scenarios, $country, IMPE.pdf", replace




* daily hospital incidence, reference scenario
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily outcome) title("COVID-19 daily hospital incidence, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "13DayHoiIMPE reference scenario - COVID-19 daily hospital incidence, reference scenario, $country, IMPE.gph", replace
qui graph export "13DayHoiIMPE reference scenario - COVID-19 daily hospital incidence, reference scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcome) title("COVID-19 daily hospital incidence, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "14DayHoiIMPE 6 scenarios - COVID-19 daily hospital incidence, 6 scenarios, $country, IMPE.gph", replace
qui graph export "14DayHoiIMPE 6 scenarios - COVID-19 daily hospital incidence, 6 scenarios, $country, IMPE.pdf", replace




* daily ICU demand, reference scenario
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily outcome) title("COVID-19 daily ICU demand, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "15DayIcdIMPE reference scenario - COVID-19 daily ICU demand, reference scenario, $country, IMPE.gph", replace
qui graph export "15DayIcdIMPE reference scenario - COVID-19 daily ICU demand, reference scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcome) title("COVID-19 daily ICU demand, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "16DayIcdIMPE 6 scenarios - COVID-19 daily ICU demand, 6 scenarios, $country, IMPE.gph", replace
qui graph export "16DayIcdIMPE 6 scenarios - COVID-19 daily ICU demand, 6 scenarios, $country, IMPE.pdf", replace




* daily ICU incidence, reference scenario
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily outcome) title("COVID-19 daily ICU incidence, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "17DayIciIMPE reference scenario - COVID-19 daily ICU incidence, reference scenario, $country, IMPE.gph", replace
qui graph export "17DayIciIMPE reference scenario - COVID-19 daily ICU incidence, reference scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcome) title("COVID-19 daily ICU incidence, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "18DayIciIMPE 6 scenarios - COVID-19 daily ICU incidence, 6 scenarios, $country, IMPE.gph", replace
qui graph export "18DayIciIMPE 6 scenarios - COVID-19 daily ICU incidence, 6 scenarios, $country, IMPE.pdf", replace




* daily R effective, reference scenario Reff
...
xlabel(, angle(forty_five)) ylabel(, format(%9.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily outcome) title("COVID-19 daily R effective, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "19DayRefIMPE reference scenario - COVID-19 daily R effective, reference scenario, $country, IMPE.gph", replace
qui graph export "19DayRefIMPE reference scenario - COVID-19 daily R effective, reference scenario, $country, IMPE.pdf", replace
...
ytitle(Daily outcome) title("COVID-19 daily R effective, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "20DayRefIMPE 6 scenarios - COVID-19 daily R effective, 6 scenarios, $country, IMPE.gph", replace
qui graph export "20DayRefIMPE 6 scenarios - COVID-19 daily R effective, 6 scenarios, $country, IMPE.pdf", replace




* daily R t, reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%9.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily outcome) title("COVID-19 daily R t, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "21DayRttIMPE reference scenario - COVID-19 daily R t, reference scenario, $country, IMPE.gph", replace
qui graph export "21DayRttIMPE reference scenario - COVID-19 daily R t, reference scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcome) title("COVID-19 daily R t, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "22DayRttIMPE 6 scenarios - COVID-19 daily R t, 6 scenarios, $country, IMPE.gph", replace
qui graph export "22DayRttIMPE 6 scenarios - COVID-19 daily R t, 6 scenarios, $country, IMPE.pdf", replace




* daily prevalence, reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily outcome) title("COVID-19 daily prevalence, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "23DayPreIMPE reference scenario - COVID-19 daily prevalence, reference scenario, $country, IMPE.gph", replace
qui graph export "23DayPreIMPE reference scenario - COVID-19 daily prevalence, reference scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcome) title("COVID-19 daily prevalence, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "24DayPreIMPE 6 scenarios - COVID-19 daily prevalence, 6 scenarios, $country, IMPE.gph", replace
qui graph export "24DayPreIMPE 6 scenarios - COVID-19 daily prevalence, 6 scenarios, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#27, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily infections and deaths) title("COVID-19 daily infections and deaths, $country, IMPE", size(medium)) ///
...
qui qui graph save "25DayDMuIMPE - COVID-19 daily deaths and infections $country, IMPE.gph", replace
qui qui graph export "25DayDMuIMPE - COVID-19 daily deaths and infections $country, IMPE.pdf", replace
...
view "log CovidVisualizedCountry IMPE.smcl"
