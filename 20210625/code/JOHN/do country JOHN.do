...
graph save "graph 2 COVID-19 daily deaths, $country, Johns Hopkins, w correction factors.gph", replace
graph export "graph 2 COVID-19 daily deaths, $country, Johns Hopkins, w correction factors.pdf", replace
...
graph save "graph 3 COVID-19 daily cases, $country, Johns Hopkins.gph", replace
graph export "graph 3 COVID-19 daily cases, $country, Johns Hopkins.pdf", replace
...
graph save "graph 4 COVID-19 daily cases, $country, Johns Hopkins, w correction factors.gph", replace
graph export "graph 4 COVID-19 daily cases, $country, Johns Hopkins, w correction factors.pdf", replace
...
graph save "graph 5 COVID-19 total deaths, $country, Johns Hopkins.gph", replace
graph export "graph 5 COVID-19 total deaths, $country, Johns Hopkins.pdf", replace
...
graph save "graph 6 COVID-19 total deaths, $country, Johns Hopkins, w correction factors.gph", replace
graph export "graph 6 COVID-19 total deaths, $country, Johns Hopkins, w correction factors.pdf", replace
...
graph save "graph 7 COVID-19 total cases, $country, Johns Hopkins.gph", replace
graph export "graph 7 COVID-19 total cases, $country, Johns Hopkins.pdf", replace
...
graph save "graph 8 COVID-19 total cases, $country, Johns Hopkins, w correction factors.gph", replace
graph export "graph 8 COVID-19 total cases, $country, Johns Hopkins, w correction factors.pdf", replace
...
graph save "graph 9 COVID-19 daily CFR, $country, Johns Hopkins.gph", replace
graph export "graph 9 COVID-19 daily CFR, $country, Johns Hopkins.pdf", replace
...
graph save "graph 10 COVID-19 daily CFR, $country, Johns Hopkins, 01dec2020 on.gph", replace
graph export "graph 10 COVID-19 daily CFR, $country, Johns Hopkins, 01dec2020 on.pdf", replace
...
graph save "graph 11 COVID-19 daily deaths and cases timing, $country, Johns Hopkins.gph", replace
graph export "graph 11 COVID-19 daily deaths and cases timing, $country, Johns Hopkins.pdf", replace
...
graph save "graph 12 COVID-19 daily recovered, $country, Johns Hopkins.gph", replace
graph export "graph 12 COVID-19 daily recovered, $country, Johns Hopkins.pdf", replace
...
graph save "graph 13 COVID-19 daily active, $country, Johns Hopkins.gph", replace
graph export "graph 13 COVID-19 daily active, $country, Johns Hopkins.pdf", replace
