...
* OBJECTIVE: Merge component studies' estimates for country, grphas
***************************************************************************
...
graph save "graph 11 COVID-19 daily deaths, $country, reference scenarios.gph", replace
graph export "graph 11 COVID-19 daily deaths, $country, reference scenarios.pdf", replace
...
graph save "graph 13 COVID-19 daily deaths, $country, reference scenarios, 2020-12-01 on.gph", replace
graph export "graph 13 COVID-19 daily deaths, $country, reference scenarios, 2020-12-01 on.pdf", replace
...
graph save "graph 14 COVID-19 daily deaths, $country, reference scenarios, 2020-12-01 on.gph", replace
graph export "graph 14 COVID-19 daily deaths, $country, reference scenarios, 2020-12-01 on.pdf", replace
...
graph save "graph 15 COVID-19 daily deaths, $country, reference scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 15 COVID-19 daily deaths, $country, reference scenarios, 2020-12-01 on, CI.pdf", replace
...
graph save "graph 16 COVID-19 daily deaths, $country, reference scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 16 COVID-19 daily deaths, $country, reference scenarios, 2020-12-01 on, CI.pdf", replace
...
graph save "graph 19 a COVID-19 daily deaths, $country, reference scenario with uncertainty, IHME.gph", replace
graph export "graph 19 a COVID-19 daily deaths, $country, reference scenario with uncertainty, IHME.pdf", replace
...
graph save "graph 19 b COVID-19 daily deaths, $country, 3 scenarios, IHME.gph", replace
graph export "graph 19 b COVID-19 daily deaths, $country, 3 scenarios, IHME.pdf", replace
...
graph save "graph 19 c COVID-19 daily deaths, $country, reference scenario with uncertainty, IMPE.gph", replace
graph export "graph 19 c COVID-19 daily deaths, $country, reference scenario with uncertainty, IMPE.pdf", replace
...
graph save "graph 19 d COVID-19 daily deaths, $country, 3 scenarios, IMPE.gph", replace
graph export "graph 19 d COVID-19 daily deaths, $country, 3 scenarios, IMPE.pdf", replace
...
graph save "graph 21 COVID-19 daily cases, $country, reference scenarios.gph", replace
graph export "graph 21 COVID-19 daily cases, $country, reference scenarios.pdf", replace
...
graph save "graph 23 COVID-19 daily cases, $country, reference scenarios, 2020-12-01 on.gph", replace
graph export "graph 23 COVID-19 daily cases, $country, reference scenarios, 2020-12-01 on.pdf", replace
...
graph save "graph 24 COVID-19 daily cases, $country, reference scenarios, 2020-12-01 on.gph", replace
graph export "graph 24 COVID-19 daily cases, $country, reference scenarios, 2020-12-01 on.pdf", replace
...
graph save "graph 26 COVID-19 daily cases, $country, reference scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 26 COVID-19 daily cases, $country, reference scenarios, 2020-12-01 on, CI.pdf", replace
...
graph save "graph 27 COVID-19 daily cases, $country, full scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 27 COVID-19 daily cases, $country, full scenarios, 2020-12-01 on, CI.pdf", replace
...
graph save "graph 29 a COVID-19 daily cases, $country, reference scenario with uncertainty, IHME.gph", replace
graph export "graph 29 a COVID-19 daily cases, $country, reference scenario with uncertainty, IHME.pdf", replace
...
graph save "graph 29 b COVID-19 daily cases, $country, 3 scenarios, IHME.gph", replace
graph export "graph 29 b COVID-19 daily cases, $country, 3 scenarios, IHME.pdf", replace
...
graph save "graph 29 c COVID-19 daily cases, $country, reference scenario with uncertainty, IMPE.gph", replace
graph export "graph 29 c COVID-19 daily cases, $country, reference scenario with uncertainty, IMPE.pdf", replace
...
graph save "graph 29 d COVID-19 daily cases, $country, 3 scenarios, IMPE.gph", replace
graph export "graph 29 d COVID-19 daily cases, $country, 3 scenarios, IMPE.pdf", replace
...
graph save "graph 31 COVID-19 total deaths, $country, reference scenarios.gph", replace
graph export "graph 31 COVID-19 total deaths, $country, reference scenarios.pdf", replace
...
graph save "graph 33 COVID-19 total deaths, $country, reference scenarios, 2020-12-01 on.gph", replace
graph export "graph 33 COVID-19 total deaths, $country, reference scenarios, 2020-12-01 on.pdf", replace
...
graph save "graph 34 COVID-19 total deaths, $country, reference scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 34 COVID-19 total deaths, $country, reference scenarios, 2020-12-01 on, CI.pdf", replace
...
graph save "graph 41 COVID-19 total cases, $country, reference scenarios.gph", replace
graph export "graph 41 COVID-19 total cases, $country, reference scenarios.pdf", replace
...
graph save "graph 43 COVID-19 total cases, $country, reference scenarios, 2020-12-01 on.gph", replace
graph export "graph 43 COVID-19 total cases, $country, reference scenarios, 2020-12-01 on.pdf", replace
...
graph save "graph 45 COVID-19 total cases, $country, reference scenarios, 2020-12-01 on, CI.gph", replace
graph export "graph 45 COVID-19 total cases, $country, reference scenarios, 2020-12-01 on, CI.pdf", replace
...
graph save "graph 51 COVID-19 daily CFR, $country, reference scenarios.gph", replace
graph export "graph 51 COVID-19 daily CFR, $country, reference scenarios.pdf", replace
...
graph save "graph 52 COVID-19 daily CFR, $country, reference scenarios, 2021-01-01 on.gph", replace
graph export "graph 52 COVID-19 daily CFR, $country, reference scenarios,2021-01-01 on.pdf", replace
...
graph save "graph 81 COVID-19 daily cases to deaths, $country, reference scenarios.gph", replace
graph export "graph 81 COVID-19 daily cases to deaths, $country, reference scenarios.pdf", replace
...
graph save "graph 82 COVID-19 daily cases to deaths, $country, reference scenarios, 2021-01-01 on.gph", replace
graph export "graph 82 COVID-19 daily cases to deaths, $country, reference scenarios, 2021-01-01 on.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases or infections to deaths) title("COVID-19 daily cases or infections, to deaths, $country, 3 scenarios", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
graph save "graph 83 COVID-19 daily cases to deaths, $country, 3 scenarios, Ordibehesht 1400 on.gph", replace
graph export "graph 83 COVID-19 daily cases to deaths, $country, 3 scenarios, Ordibehesht 1400 on.pdf", replace
...
graph save "graph 85 COVID-19 total cases to deaths, $country, reference scenarios, Ordibehesht 1400 on.gph", replace
graph export "graph 85 COVID-19 total cases to deaths, $country, reference scenarios, Ordibehesht 1400 on.pdf", replace
...
graph save "graph 91 COVID-19 daily deaths estimated to reported, $country, reference scenarios.gph", replace
graph export "graph 91 COVID-19 daily deaths estimated to reported, $country, reference scenarios.pdf", replace
...
graph save "graph 92 COVID-19 daily deaths estimated to reported, $country, reference scenarios, 2021-01-01 on.gph", replace
graph export "graph 92 COVID-19 daily deaths estimated to reported, $country, reference scenarios, 2021-01-01 on.pdf", replace
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases or infections estimated to reported) title("COVID-19 daily cases or infections estimated, to reported cases, $country", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN cases" 2 "DELP cases" 3 "IHME infections" 4 "IMPE infections" 5 "LANL cases" 6 "SRIV cases") size(small) row(2)) ///
subtitle("reference scenarios", size(small))

graph save "graph 93 COVID-19 daily cases estimated to reported, $country, reference scenarios.gph", replace
graph export "graph 93 COVID-19 daily cases estimated to reported, $country, reference scenarios.pdf", replace
...
graph save "graph 94 COVID-19 daily cases estimated to reported, $country, reference scenarios, 2021-01-01 on.gph", replace
graph export "graph 94 COVID-19 daily cases estimated to reported, $country, reference scenarios, 2021-01-01 on.pdf", replace
...
graph save "graph 95 COVID-19 total deaths estimated to reported, $country, reference scenarios.gph", replace
graph export "graph 95 COVID-19 total deaths estimated to reported, $country, reference scenarios.pdf", replace
...
graph save "graph 96 COVID-19 total deaths estimated to reported, $country, reference scenarios, 2021-01-01 on.gph", replace
graph export "graph 96 COVID-19 total deaths estimated to reported, $country, reference scenarios, 2021-01-01 on.pdf", replace
...
, xtitle(Date) xlabel(#24, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases or infections estimated to reported) title("COVID-19 total cases or infections estimated, to reported cases, $country", size(medium)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "JOHN cases" 2 "DELP cases" 3 "IHME infections" 4 "IMPE infections" 5 "LANL cases" 6 "SRIV cases") size(small) row(2)) ///
subtitle("reference scenarios", size(small))
...
graph save "graph 98 COVID-19 total cases estimated to reported, $country, reference scenarios, 2021-01-01 on.gph", replace
graph export "graph 98 COVID-19 total cases estimated to reported, $country, reference scenarios, 2021-01-01 on.pdf", replace
