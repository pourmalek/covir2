...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20220603 (old), with 20220603 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220603/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220603\code"
}
*
...
do "$pathcovir2/IMPE/do country IMPE.do" // IMPE update 20220315 was released on 20220505 and is 60 days old on 20220603. Not included.
