...
Run in Stata the _master do file_ on your local machine after the _downloaded _repository directory_ is stored in the root of /Downloads/ folder of your local machine.
