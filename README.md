...
5. Go to your local directory |Downloads|covir2-main|Data|merge| and view the produced graphs stored in PDF files (starting with graph 11 COVID-19 daily deaths, Iran, reference scenarios, with DELPHI.PDF). | means / or \ depending on local OS. 
