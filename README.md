...
Files "graph 1a" to "graph 5b" stored in "Users|local-user-name|Downloads|covir2-main|Data|merge|" of the local machine (your computer) will be the final graphs that use Farsi (Hijri Solar) dates.  
