...
برآوردهای پنج مطالعه بین المللی بروز-شونده برای همه گیری کووید-۱۹ در ایران به صورت نمودار، فایل و کد نرم افزار در این سایت گیت هاب (https://github.com/pourmalek/covir2) قابل دیدن و دانلود هستند.

به روز-رسانی های متوالی مدل ها به صورت دوره ای به این سایت اضافه خواهند شد.

مشابه این کار برای سطح جهانی در حال آماده سازی جهت ارایه درhttps://github.com/pourmalek/GlobalCovidCombineVisualize  می باشد.
