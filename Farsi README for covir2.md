...
اگر یک کاربر بخواهد کد های نرم افزار استیتای موجود در (سایت covir2) را اجرا کند، می بایست ابتدا آن ها را داونلود نماید،‌که در زیر توضیح داده شده است. لازم است به مفاد و محتوی مجوز مربوطه (https://github.com/pourmalek/covir2/blob/main/LICENSE)[در اینجا] توجه شود. این کد های نرم افزار ممکن است حاوی اشتباهاتی باشند و به صورت (as is) به اشتراک گذاشته شده اند و هر گونه عواقب هر گونه تصمیم گیری بر مبنای کد ها و نمودارهای موجود در (سایت covir2) بر عهده تصمیم گیرنده یا تصمیم گیرندگان است و نه بر عهده پدید آورنده یا عهده پدید آورندگان (سایت covir2). 
