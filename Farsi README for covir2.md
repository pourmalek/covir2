...
برآوردهای پنج مطالعه بین المللی به صورت دوره ای به روز می شوند. در (سایت covir2) نیز نتایج این به روز-رسانی ها به صورت دوره ای به سایت اضافه می شود. به روز رسانی نتایج مدل ها در این بررسی تا کنون چهار مرتبه صورت گرفته است، در تاریخ های (20210405)، (20210413)، (20210416)، (20210423). هر بار یک دایرکتوری با نام تاریخ به روز رسانی ایجاد می گردد. 

در داخل دایرکتوری هر یک از به روز رسانی ها،‌ دو دایرکتوری (code) و (output) که به ترتیب حاوی کد های نرم افزار استیتا و خروجی کد ها می باشند. در داخل هر یک از این دو دایرکتوری،‌ دایرکتوری هایی برای هر مطالعه وجود دارد (اسامی اختصاری در اینجا توضیح داده شده اند) و دو دایرکتوری دیگر به نام های (master) ‌و (merge). دایرکتوری (master) حاوی یک کد استیتا است به نام (do Iran master.do) که اجرای آن روی کامپیوتر کاربر،‌ بعد از داونلود به کامپیوتر کاربر، ‌باعث اجرای سایر کدها و تولید نمودارها و سایر خروجی ها می گردد. دایرکتوری (merge) حاوی کدی است که نتایج حاصل شده از کدهای مربوط به هر یک از مطالعات را گردآوری کرده و برای هر پیامد (مثلا مرگ های روزانه) نمودار حاصل از همه مطالعات را ترسیم می کند. 
...
در صورت مواجهه با اشکال در اجرای کد،‌ به قسمت رفع مشکلات در اینجا مراجعه شود. در صورت رفع نشدن اشکال، و همچنین در صورت مشاهده اشتباه (bug) در کد ها، می توان به اینجا مراجعه نمود، یا به پدید آورنده ای-میل زد. 
