...
در صورت مواجهه با اشکال در اجرای کد،‌ به قسمت رفع مشکلات در (https://github.com/pourmalek/covir2/blob/main/Troubleshooting.md)[اینجا] مراجعه شود. در صورت رفع نشدن اشکال، و همچنین در صورت مشاهده اشتباه (bug) در کد ها، می توان به اینجا مراجعه نمود، یا به پدید آورنده ای-میل زد. 
