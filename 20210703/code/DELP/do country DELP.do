...
******************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 20210703 (old), with 20210703 (new) <<--           <<<--- * change update date here *
                                                                                                         ***************************
...
copy https://raw.githubusercontent.com/COVIDAnalytics/website/master/data/predicted/Global_V4_20210703.csv Global_V4_20210703.csv

import delimited using "Global_V4_20210703.csv", clear varnames(1)
