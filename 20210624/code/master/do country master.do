...
* This is "do country master.do"
                                                                                                          ***************************
* Project: CovidVisualized country - countries without subnational estimates                              * this is uptake 20210624 *
...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20210624 (old), with 20210624 (new) <<--           <<<--- * change uptake date here *
                                                                                                         ***************************
...
data in covir2-main/20210624/output/merge/country.dta
and graphs stored in:
covir2-main/covir2/20210624/output/merge/*.pdf
and covir2-main/20210624/output/IMPE/*.pdf
