...
, xtitle(Date) xlabel(#`xticks', format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily infections) title("COVID-19 daily infections, Iran, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
graph save "graph 5 COVID-19 daily infections, 6 scenarios, Iran, IMPE.gph", replace
graph export "graph 5 COVID-19 daily infections, 6 scenarios, Iran, IMPE.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily infections) title("COVID-19 daily infections, Iran, IMPE, median scenario", size(medium)) legend(off)

graph save "graph 6 COVID-19 daily infections, median scenario, Iran, IMPE.gph", replace
graph export "graph 6 COVID-19 daily infections, median scenario, Iran, IMPE.pdf", replace
...
ytitle(Total infections) title("COVID-19 total infections, Iran, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
graph save "graph 7 COVID-19 total infections, 6 scenarios, Iran, IMPE.gph", replace
graph export "graph 7 COVID-19 total infections, 6 scenarios, Iran, IMPE.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Total infections) title("COVID-19 total infections, Iran, IMPE, median scenario", size(medium)) legend(off)

graph save "graph 8 COVID-19 total infections, median scenario, Iran, IMPE.gph", replace
graph export "graph 8 COVID-19 total infections, median scenario, Iran, IMPE.pdf", replace
...
ytitle(Daily IFR) title("COVID-19 daily IFR, Iran, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
graph save "graph 9 COVID-19 daily IFR, 6 scenarios, Iran, IMPE.gph", replace
graph export "graph 9 COVID-19 daily IFR, 6 scenarios, Iran, IMPE.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%9.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily IFR) title("COVID-19 daily IFR, Iran, IMPE, median scenario", size(medium)) legend(off)

graph save "graph 10 COVID-19 daily IFR, median scenario, Iran, IMPE.gph", replace
graph export "graph 10 COVID-19 daily IFR, median scenario, Iran, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#`xticks', format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily infections and deaths) title("COVID-19 daily infections and deaths, Iran, IMPE", size(medium)) ///
...
qui graph save "graph 25 COVID-19 daily deaths and infections Iran, IMPE.gph", replace
qui graph export "graph 25 COVID-19 daily deaths and infections Iran, IMPE.pdf", replace
