...
******************************************************************************
                                                                                                         ...
                                                                                                         ***************************
* To change update date, find and replace all, 20210624 (old), with 20210624 (new) <<--           <<<--- * change update date here *
                                                                                                         ***************************
...
copy https://raw.githubusercontent.com/COVIDAnalytics/website/master/data/predicted/Global_V4_20210624.csv Global_V4_20210624.csv

import delimited using "Global_V4_20210624.csv", clear varnames(1)
