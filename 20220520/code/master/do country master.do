...
DELP 20220520, IHME 20220506, No IMPE, SRIV 20220520
...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20220520 (old), with 20220520 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************
...
global DELPepoch 20May2022 // update release date
*            2/ ----------
...
global SRIVepoch 20May2022 // update release date																		 
*            9/ ----------
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220520/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220520\code"
}
*
...
do "$pathcovir2/IMPE/do country IMPE.do" // IMPE update 20220315 was released on 20220505 and is 60 days old on 20220520. Not included.
