...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20220116 (old), with 20220116 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************

* To change uptake date in individual do files for models, change the following dates:

global DELPdate 20220115 // 20220116 not available yet
*            2/ --------

global IMPEdate 2022-01-02_v9
*            3/ -------------

global SRIVdate 2022-01-16
*            4/ ----------

* The IHME update being used is January 14, 2022																			 
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20220116/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20220116\code"
}
*
