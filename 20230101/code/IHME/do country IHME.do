...
capture shell rm -r "data_download_file_reference_2020.csv"
...
capture shell rm -r "data_download_file_reference_2021.csv"
...
capture shell rm -r "data_download_file_reference_2022.csv"
...
capture shell rm -r "data_download_file_reference_2023.csv"
					   
copy https://ihmecovid19storage.blob.core.windows.net/latest/data_download_file_reference_2023.csv data_download_file_reference_2023.csv
					   
import delimited using data_download_file_reference_2023.csv, clear varnames(1)
keep if regexm(location_name,"$country") == 1
save data_download_file_reference_2023.dta, replace



* scenario name = version_name = best_masks = Masks
	                   
capture shell rm -r "data_download_file_best_masks_2020.csv"
...
capture shell rm -r "data_download_file_best_masks_2021.csv"
...
capture shell rm -r "data_download_file_best_masks_2022.csv"
...
capture shell rm -r "data_download_file_best_masks_2023.csv"
			   
copy https://ihmecovid19storage.blob.core.windows.net/latest/data_download_file_best_masks_2023.csv data_download_file_best_masks_2023.csv					   
			   
import delimited using data_download_file_best_masks_2023.csv, clear varnames(1)
keep if regexm(location_name,"$country") == 1
save data_download_file_best_masks_2023.dta, replace
...
capture shell rm -r "data_download_file_global_antivirals_2020.csv"

copy https://ihmecovid19storage.blob.core.windows.net/latest/data_download_file_global_antivirals_2020.csv data_download_file_global_antivirals_2020.csv					   
					   
import delimited using data_download_file_global_antivirals_2020.csv, clear varnames(1)
keep if regexm(location_name,"$country") == 1
save data_download_file_global_antivirals_2020.dta, replace


capture shell rm -r "data_download_file_global_antivirals_2021.csv"

copy https://ihmecovid19storage.blob.core.windows.net/latest/data_download_file_global_antivirals_2021.csv data_download_file_global_antivirals_2021.csv					   

import delimited using data_download_file_global_antivirals_2021.csv, clear varnames(1)
keep if regexm(location_name,"$country") == 1
save data_download_file_global_antivirals_2021.dta, replace
                       
					   
capture shell rm -r "data_download_file_global_antivirals_2022.csv"
					   
copy https://ihmecovid19storage.blob.core.windows.net/latest/data_download_file_global_antivirals_2022.csv data_download_file_global_antivirals_2022.csv					   
					   
import delimited using data_download_file_global_antivirals_2022.csv, clear varnames(1)
keep if regexm(location_name,"$country") == 1
save data_download_file_global_antivirals_2022.dta, replace


capture shell rm -r "data_download_file_global_antivirals_2023.csv"
					   
copy https://ihmecovid19storage.blob.core.windows.net/latest/data_download_file_global_antivirals_2023.csv data_download_file_global_antivirals_2023.csv					   
					   
import delimited using data_download_file_global_antivirals_2023.csv, clear varnames(1)
keep if regexm(location_name,"$country") == 1
save data_download_file_global_antivirals_2023.dta, replace
...
use "data_download_file_reference_2023.dta", clear 
...
append using "data_download_file_reference_2023.dta"
...
use "data_download_file_best_masks_2023.dta", clear
...
append using "data_download_file_best_masks_2023.dta"
...
use "data_download_file_global_antivirals_2023.dta", clear 
...
save "data_download_file_antiviral_2023.dta", replace 
...
append using "data_download_file_antiviral_2023.dta"
...
drop _merge
merge 1:1 location_name date using "Antivirals country.dta"
drop _merge
