...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20230101 (old), with 20230101 (new) <<--           <<<--- * change uptake date here *
*                                           1/ --------                                                  ***************************
...
global DELPepoch 15Sep2022 // update release date
*            2/ ----------

global IHMEepoch 09Dec2022 // as per https://covid19.healthdata.org/iran-(islamic-republic-of)?view=daily-deaths&tab=trend
*            3/ ----------

global IMPEdate 2022-09-01_v9  
*            4/ -------------

global SRIVdate 2022-12-05
*            5/ ----------
...
global DELPdate 20220915
*            6/ --------

global IHMEdate 2022-12-16
*            7/ --------

global IMPEepoch 01Sep2022 // update release date																		 
*            8/ ----------

global SRIVepoch 05Dec2022 // update release date																		 
*            9/ ----------
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20230101/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20230101\code"
}
*
