...
/*
twoway ///
(line DayBedMeSmA02S01V03 date, sort lcolor(black)) /// 1 "Bed"
(line DayIcuMeSmA02S01V03 date, sort lcolor(green)) /// 2 "ICU"
(line DayVenMeSmA02S01V03 date, sort lcolor(red)) /// 3 "Vent"
(line DayAdmMeSmA02S01V03 date, sort lcolor(yellow)) /// 4 "Adm"
(line DayIcnMeSmA02S01V03 date, sort lcolor(blue)) /// 5 "ICU new"
, xtitle(Date) xlabel(#`xticks', format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
(line DayBedMeSmA02S01V03 date, sort lcolor(black)) /// 1 "Bed"
(line DayIcuMeSmA02S01V03 date, sort lcolor(green)) /// 2 "ICU"
(line DayAdmMeSmA02S01V03 date, sort lcolor(yellow)) /// 3 "Adm"
(line DayIcnMeSmA02S01V03 date, sort lcolor(blue)) /// 4 "ICU new"
, xtitle(Date) xlabel(#`xticks', format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcomes) title("COVID-19 daily hospital-related outcomes Iran, IHME, median scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
/*
twoway ///
(line DayIcuMeSmA02S01V03 date, sort lcolor(green)) /// 1 "ICU"
(line DayVenMeSmA02S01V03 date, sort lcolor(red)) /// 2 Vent"
(line DayAdmMeSmA02S01V03 date, sort lcolor(yellow)) /// 3 "Adm"
(line DayIcnMeSmA02S01V03 date, sort lcolor(blue)) /// 4 "ICU new"
, xtitle(Date) xlabel(#`xticks', format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
...
twoway ///
(line DayIcuMeSmA02S01V03 date, sort lcolor(green)) /// 1 "ICU"
(line DayAdmMeSmA02S01V03 date, sort lcolor(yellow)) /// 2 "Adm"
(line DayIcnMeSmA02S01V03 date, sort lcolor(blue)) /// 3 "ICU new"
, xtitle(Date) xlabel(#`xticks', format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcomes) title("COVID-19 daily hospital-related outcomes Iran, IHME, median scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
