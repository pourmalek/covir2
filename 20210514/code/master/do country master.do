...
* This is "do country master.do"
                                                                                                          ***************************
* Project: CovidVisualized country - countries without subnational estimates                              * this is uptake 20210514 *
...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20210514 (old), with 20210514 (new) <<--           <<<--- * change uptake date here *
                                                                                                         ***************************
...
if regexm(c(os),"Mac") == 1 {
	global pathcovir2 "/Users/`usrnam'/Downloads/covir2-main/20210514/code" 
}
else if regexm(c(os),"Windows") {
	global pathcovir2 = "C:\Users\\`usrnam'\Downloads\covir2-main\20210514\code"
}
*
...
data in covir2-main/20210514/output/merge/country.dta
and graphs stored in:
covir2-main /covir2/20210514/output/merge/*.pdf
and covir2-main /20210514/output/IMPE/*.pdf
